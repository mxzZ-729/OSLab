...
main(int argc, char **argv)
{
  ...
  39:	e8 8c 03 00 00       	call   3ca <kill>
  for(i=1; i<argc; i++)
  3e:	83 c4 10             	add    $0x10,%esp
  41:	39 de                	cmp    %ebx,%esi
  43:	75 e3                	jne    28 <main+0x28>
  exit();
  45:	e8 50 03 00 00       	call   39a <exit>
    printf(2, "usage: kill pid...\n");
  4a:	50                   	push   %eax
  4b:	50                   	push   %eax
  ...
  53:	e8 98 04 00 00       	call   4f0 <printf>
    exit();
  58:	e8 3d 03 00 00       	call   39a <exit>
  5d:	66 90                	xchg   %ax,%ax
  5f:	90                   	nop
 ...
 458:	89 d1                	mov    %edx,%ecx
{
 ...
 48b:	0f b6 92 6c 08 00 00 	movzbl 0x86c(%edx),%edx
 ...
 4f9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 564:	ff 24 85 14 08 00 00 	jmp    *0x814(,%eax,4)
 ...
 670:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 675:	bb 0c 08 00 00       	mov    $0x80c,%ebx
 ...
 681:	a1 c8 0b 00 00       	mov    0xbc8,%eax
{
 ...
 6bf:	5b                   	pop    %ebx
  freep = p;
 6c0:	a3 c8 0b 00 00       	mov    %eax,0xbc8
}
 6c5:	5e                   	pop    %esi
 6c6:	5f                   	pop    %edi
 6c7:	5d                   	pop    %ebp
 ...
 6d6:	72 ce                	jb     6a6 <free+0x26>
{
 ...
 6f7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6fa:	a3 c8 0b 00 00       	mov    %eax,0xbc8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 719:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 71c:	8b 15 c8 0b 00 00    	mov    0xbc8,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 75b:	3b 05 c8 0b 00 00    	cmp    0xbc8,%eax
 ...
 77e:	e8 fd fe ff ff       	call   680 <free>
  return freep;
 783:	8b 15 c8 0b 00 00    	mov    0xbc8,%edx
 ...
 7c7:	0b 00 00 
    base.s.size = 0;
 7ca:	b8 cc 0b 00 00       	mov    $0xbcc,%eax
    base.s.ptr = freep = prevp = &base;
 7cf:	c7 05 cc 0b 00 00 cc 	movl   $0xbcc,0xbcc
 7d6:	0b 00 00 
    base.s.size = 0;
 7d9:	c7 05 d0 0b 00 00 00 	movl   $0x0,0xbd0
 7e0:	00 00 00 
    if(p->s.size >= nunits){
