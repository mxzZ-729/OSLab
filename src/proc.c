...
wait(void)
{
  ...
  for(;;){
    ...
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
      // only wait for child process that does not share the address space with this process
...
clone (void(*fcn)(void *, void *), void *arg1, void *arg2, void *stack)
{
  ...
  *np->tf = *curproc->tf;
  ...
  /*
  * The stack register %esp, always contains a pointer 
  * to the current top of the stack, wherever it is.
