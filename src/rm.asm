...
main(int argc, char *argv[])
{
  ...
  3d:	ff 33                	push   (%ebx)
  3f:	e8 c6 03 00 00       	call   40a <unlink>
 ...
 478:	89 d1                	mov    %edx,%ecx
{
 ...
 4ab:	0f b6 92 a4 08 00 00 	movzbl 0x8a4(%edx),%edx
 ...
 519:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 584:	ff 24 85 4c 08 00 00 	jmp    *0x84c(,%eax,4)
 ...
 690:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 695:	bb 45 08 00 00       	mov    $0x845,%ebx
...
free(void *ap)
{
 ...
 6a1:	a1 00 0c 00 00       	mov    0xc00,%eax
{
 ...
 6df:	5b                   	pop    %ebx
  freep = p;
 6e0:	a3 00 0c 00 00       	mov    %eax,0xc00
}
 6e5:	5e                   	pop    %esi
 6e6:	5f                   	pop    %edi
 6e7:	5d                   	pop    %ebp
 ...
 6f6:	72 ce                	jb     6c6 <free+0x26>
{
 ...
 717:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 71a:	a3 00 0c 00 00       	mov    %eax,0xc00
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 739:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 73c:	8b 15 00 0c 00 00    	mov    0xc00,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 77b:	3b 05 00 0c 00 00    	cmp    0xc00,%eax
 ...
 79e:	e8 fd fe ff ff       	call   6a0 <free>
  return freep;
 7a3:	8b 15 00 0c 00 00    	mov    0xc00,%edx
 ...
 7e7:	0c 00 00 
    base.s.size = 0;
 7ea:	b8 04 0c 00 00       	mov    $0xc04,%eax
    base.s.ptr = freep = prevp = &base;
 7ef:	c7 05 04 0c 00 00 04 	movl   $0xc04,0xc04
 7f6:	0c 00 00 
    base.s.size = 0;
 7f9:	c7 05 08 0c 00 00 00 	movl   $0x0,0xc08
 800:	00 00 00 
    if(p->s.size >= nunits){
