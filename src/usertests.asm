...
main(int argc, char *argv[])
{
  ...
  printf(1, "usertests starting\n");
      ...
      16:	6a 01                	push   $0x1
      18:	e8 03 3b 00 00       	call   3b20 <printf>
  ...
  if(open("usertests.ran", 0) >= 0){
      ...
      26:	e8 df 39 00 00       	call   3a0a <open>
    ...
    printf(1, "already ran user tests -- rebuild fs.img\n");
      ...
      39:	6a 01                	push   $0x1
      3b:	e8 e0 3a 00 00       	call   3b20 <printf>
    exit();
      40:	e8 85 39 00 00       	call   39ca <exit>
  }
  close(open("usertests.ran", O_CREATE));
      ...
      51:	e8 b4 39 00 00       	call   3a0a <open>
      56:	89 04 24             	mov    %eax,(%esp)
      59:	e8 94 39 00 00       	call   39f2 <close>
  ...
  exit();
     10d:	e8 b8 38 00 00       	call   39ca <exit>
...
00000120 <iputtest>:
{
  ...
  printf(stdout, "iput test\n");
     ...
     12b:	ff 35 b8 5f 00 00    	push   0x5fb8
     131:	e8 ea 39 00 00       	call   3b20 <printf>
  if(mkdir("iputdir") < 0){
     136:	c7 04 24 4f 3e 00 00 	movl   $0x3e4f,(%esp)
     13d:	e8 f0 38 00 00       	call   3a32 <mkdir>
  ...
  if(chdir("iputdir") < 0){
     ...
     151:	e8 e4 38 00 00       	call   3a3a <chdir>
  ...
  if(unlink("../iputdir") < 0){
     ...
     169:	e8 ac 38 00 00       	call   3a1a <unlink>
  ...
  if(chdir("/") < 0){
     ...
     17d:	e8 b8 38 00 00       	call   3a3a <chdir>
  ...
  printf(stdout, "iput test ok\n");
     ...
     191:	ff 35 b8 5f 00 00    	push   0x5fb8
     197:	e8 84 39 00 00       	call   3b20 <printf>
}
    ...
    printf(stdout, "mkdir failed\n");
     ...
     1a8:	ff 35 b8 5f 00 00    	push   0x5fb8
     1ae:	e8 6d 39 00 00       	call   3b20 <printf>
    exit();
     1b3:	e8 12 38 00 00       	call   39ca <exit>
    printf(stdout, "chdir / failed\n");
     1b8:	50                   	push   %eax
     1b9:	50                   	push   %eax
     1ba:	68 73 3e 00 00       	push   $0x3e73
     1bf:	ff 35 b8 5f 00 00    	push   0x5fb8
     1c5:	e8 56 39 00 00       	call   3b20 <printf>
    exit();
     1ca:	e8 fb 37 00 00       	call   39ca <exit>
    printf(stdout, "unlink ../iputdir failed\n");
     1cf:	52                   	push   %edx
     1d0:	52                   	push   %edx
     1d1:	68 57 3e 00 00       	push   $0x3e57
     1d6:	ff 35 b8 5f 00 00    	push   0x5fb8
     1dc:	e8 3f 39 00 00       	call   3b20 <printf>
    exit();
     1e1:	e8 e4 37 00 00       	call   39ca <exit>
    printf(stdout, "chdir iputdir failed\n");
     1e6:	51                   	push   %ecx
     1e7:	51                   	push   %ecx
     1e8:	68 36 3e 00 00       	push   $0x3e36
     1ed:	ff 35 b8 5f 00 00    	push   0x5fb8
     1f3:	e8 28 39 00 00       	call   3b20 <printf>
    exit();
     1f8:	e8 cd 37 00 00       	call   39ca <exit>
...
00000200 <exitiputtest>:
{
  ...
  printf(stdout, "exitiput test\n");
     ...
     20b:	ff 35 b8 5f 00 00    	push   0x5fb8
     211:	e8 0a 39 00 00       	call   3b20 <printf>
  pid = fork();
     216:	e8 a7 37 00 00       	call   39c2 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     230:	e8 fd 37 00 00       	call   3a32 <mkdir>
    ...
    if(chdir("iputdir") < 0){
     ...
     248:	e8 ed 37 00 00       	call   3a3a <chdir>
    ...
    if(unlink("../iputdir") < 0){
     ...
     260:	e8 b5 37 00 00       	call   3a1a <unlink>
     265:	83 c4 10             	add    $0x10,%esp
     268:	85 c0                	test   %eax,%eax
     26a:	78 2c                	js     298 <exitiputtest+0x98>
    exit();
     26c:	e8 59 37 00 00       	call   39ca <exit>
     271:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  wait();
     278:	e8 55 37 00 00       	call   39d2 <wait>
  printf(stdout, "exitiput test ok\n");
     27d:	83 ec 08             	sub    $0x8,%esp
     280:	68 a6 3e 00 00       	push   $0x3ea6
     285:	ff 35 b8 5f 00 00    	push   0x5fb8
     28b:	e8 90 38 00 00       	call   3b20 <printf>
}
     ...
     2a0:	ff 35 b8 5f 00 00    	push   0x5fb8
     2a6:	e8 75 38 00 00       	call   3b20 <printf>
      exit();
     2ab:	e8 1a 37 00 00       	call   39ca <exit>
    printf(stdout, "fork failed\n");
     2b0:	51                   	push   %ecx
     2b1:	51                   	push   %ecx
     2b2:	68 69 4d 00 00       	push   $0x4d69
     2b7:	ff 35 b8 5f 00 00    	push   0x5fb8
     2bd:	e8 5e 38 00 00       	call   3b20 <printf>
    exit();
     2c2:	e8 03 37 00 00       	call   39ca <exit>
      printf(stdout, "mkdir failed\n");
     2c7:	52                   	push   %edx
     2c8:	52                   	push   %edx
     2c9:	68 28 3e 00 00       	push   $0x3e28
     2ce:	ff 35 b8 5f 00 00    	push   0x5fb8
     2d4:	e8 47 38 00 00       	call   3b20 <printf>
      exit();
     2d9:	e8 ec 36 00 00       	call   39ca <exit>
      printf(stdout, "child chdir failed\n");
     2de:	50                   	push   %eax
     2df:	50                   	push   %eax
     2e0:	68 92 3e 00 00       	push   $0x3e92
     2e5:	ff 35 b8 5f 00 00    	push   0x5fb8
     2eb:	e8 30 38 00 00       	call   3b20 <printf>
      exit();
     2f0:	e8 d5 36 00 00       	call   39ca <exit>
...
00000300 <openiputtest>:
{
  ...
  printf(stdout, "openiput test\n");
     ...
     30b:	ff 35 b8 5f 00 00    	push   0x5fb8
     311:	e8 0a 38 00 00       	call   3b20 <printf>
  if(mkdir("oidir") < 0){
     316:	c7 04 24 c7 3e 00 00 	movl   $0x3ec7,(%esp)
     31d:	e8 10 37 00 00       	call   3a32 <mkdir>
     322:	83 c4 10             	add    $0x10,%esp
     325:	85 c0                	test   %eax,%eax
     327:	0f 88 9f 00 00 00    	js     3cc <openiputtest+0xcc>
  pid = fork();
     32d:	e8 90 36 00 00       	call   39c2 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     342:	e8 c3 36 00 00       	call   3a0a <open>
    if(fd >= 0){
     ...
     356:	ff 35 b8 5f 00 00    	push   0x5fb8
     35c:	e8 bf 37 00 00       	call   3b20 <printf>
      exit();
     361:	e8 64 36 00 00       	call   39ca <exit>
  ...
  sleep(1);
     ...
     373:	6a 01                	push   $0x1
     375:	e8 e0 36 00 00       	call   3a5a <sleep>
  if(unlink("oidir") != 0){
     37a:	c7 04 24 c7 3e 00 00 	movl   $0x3ec7,(%esp)
     381:	e8 94 36 00 00       	call   3a1a <unlink>
     386:	83 c4 10             	add    $0x10,%esp
     389:	85 c0                	test   %eax,%eax
     38b:	75 56                	jne    3e3 <openiputtest+0xe3>
  wait();
     38d:	e8 40 36 00 00       	call   39d2 <wait>
  printf(stdout, "openiput test ok\n");
     392:	83 ec 08             	sub    $0x8,%esp
     395:	68 f0 3e 00 00       	push   $0x3ef0
     39a:	ff 35 b8 5f 00 00    	push   0x5fb8
     3a0:	e8 7b 37 00 00       	call   3b20 <printf>
}
    ...
    exit();
     3b0:	e8 15 36 00 00       	call   39ca <exit>
    printf(stdout, "fork failed\n");
     3b5:	52                   	push   %edx
     3b6:	52                   	push   %edx
     3b7:	68 69 4d 00 00       	push   $0x4d69
     3bc:	ff 35 b8 5f 00 00    	push   0x5fb8
     3c2:	e8 59 37 00 00       	call   3b20 <printf>
    exit();
     3c7:	e8 fe 35 00 00       	call   39ca <exit>
    printf(stdout, "mkdir oidir failed\n");
     3cc:	51                   	push   %ecx
     3cd:	51                   	push   %ecx
     3ce:	68 cd 3e 00 00       	push   $0x3ecd
     3d3:	ff 35 b8 5f 00 00    	push   0x5fb8
     3d9:	e8 42 37 00 00       	call   3b20 <printf>
    exit();
     3de:	e8 e7 35 00 00       	call   39ca <exit>
    printf(stdout, "unlink failed\n");
     3e3:	50                   	push   %eax
     3e4:	50                   	push   %eax
     3e5:	68 e1 3e 00 00       	push   $0x3ee1
     3ea:	ff 35 b8 5f 00 00    	push   0x5fb8
     3f0:	e8 2b 37 00 00       	call   3b20 <printf>
    exit();
     3f5:	e8 d0 35 00 00       	call   39ca <exit>
...
00000400 <opentest>:
{
  ...
  printf(stdout, "open test\n");
     ...
     40b:	ff 35 b8 5f 00 00    	push   0x5fb8
     411:	e8 0a 37 00 00       	call   3b20 <printf>
  fd = open("echo", 0);
     416:	58                   	pop    %eax
     417:	5a                   	pop    %edx
     418:	6a 00                	push   $0x0
     41a:	68 0d 3f 00 00       	push   $0x3f0d
     41f:	e8 e6 35 00 00       	call   3a0a <open>
  if(fd < 0){
  ...
  close(fd);
     ...
     42e:	50                   	push   %eax
     42f:	e8 be 35 00 00       	call   39f2 <close>
  fd = open("doesnotexist", 0);
     434:	5a                   	pop    %edx
     435:	59                   	pop    %ecx
     436:	6a 00                	push   $0x0
     438:	68 25 3f 00 00       	push   $0x3f25
     43d:	e8 c8 35 00 00       	call   3a0a <open>
  if(fd >= 0){
  ...
  printf(stdout, "open test ok\n");
     ...
     451:	ff 35 b8 5f 00 00    	push   0x5fb8
     457:	e8 c4 36 00 00       	call   3b20 <printf>
}
    ...
    printf(stdout, "open echo failed!\n");
     ...
     468:	ff 35 b8 5f 00 00    	push   0x5fb8
     46e:	e8 ad 36 00 00       	call   3b20 <printf>
    exit();
     473:	e8 52 35 00 00       	call   39ca <exit>
    printf(stdout, "open doesnotexist succeeded!\n");
     478:	50                   	push   %eax
     479:	50                   	push   %eax
     47a:	68 32 3f 00 00       	push   $0x3f32
     47f:	ff 35 b8 5f 00 00    	push   0x5fb8
     485:	e8 96 36 00 00       	call   3b20 <printf>
    exit();
     48a:	e8 3b 35 00 00       	call   39ca <exit>
     48f:	90                   	nop
...
00000490 <writetest>:
{
  ...
  printf(stdout, "small file test\n");
     ...
     49d:	ff 35 b8 5f 00 00    	push   0x5fb8
     4a3:	e8 78 36 00 00       	call   3b20 <printf>
  fd = open("small", O_CREATE|O_RDWR);
     4a8:	58                   	pop    %eax
     4a9:	5a                   	pop    %edx
     4aa:	68 02 02 00 00       	push   $0x202
     4af:	68 6f 3f 00 00       	push   $0x3f6f
     4b4:	e8 51 35 00 00       	call   3a0a <open>
  if(fd >= 0){
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     ...
     4d0:	ff 35 b8 5f 00 00    	push   0x5fb8
     4d6:	e8 45 36 00 00       	call   3b20 <printf>
    ...
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     4ea:	56                   	push   %esi
     4eb:	e8 fa 34 00 00       	call   39ea <write>
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     506:	56                   	push   %esi
     507:	e8 de 34 00 00       	call   39ea <write>
  ...
  printf(stdout, "writes ok\n");
     ...
     528:	ff 35 b8 5f 00 00    	push   0x5fb8
     52e:	e8 ed 35 00 00       	call   3b20 <printf>
  close(fd);
     533:	89 34 24             	mov    %esi,(%esp)
     536:	e8 b7 34 00 00       	call   39f2 <close>
  fd = open("small", O_RDONLY);
     53b:	5b                   	pop    %ebx
     53c:	5e                   	pop    %esi
     53d:	6a 00                	push   $0x0
     53f:	68 6f 3f 00 00       	push   $0x3f6f
     544:	e8 c1 34 00 00       	call   3a0a <open>
  if(fd >= 0){
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     55e:	ff 35 b8 5f 00 00    	push   0x5fb8
     564:	e8 b7 35 00 00       	call   3b20 <printf>
  i = read(fd, buf, 2000);
     569:	83 c4 0c             	add    $0xc,%esp
     56c:	68 d0 07 00 00       	push   $0x7d0
     571:	68 00 87 00 00       	push   $0x8700
     576:	53                   	push   %ebx
     577:	e8 66 34 00 00       	call   39e2 <read>
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     592:	ff 35 b8 5f 00 00    	push   0x5fb8
     598:	e8 83 35 00 00       	call   3b20 <printf>
  close(fd);
     59d:	89 1c 24             	mov    %ebx,(%esp)
     5a0:	e8 4d 34 00 00       	call   39f2 <close>
  if(unlink("small") < 0){
     5a5:	c7 04 24 6f 3f 00 00 	movl   $0x3f6f,(%esp)
     5ac:	e8 69 34 00 00       	call   3a1a <unlink>
  ...
  printf(stdout, "small file test ok\n");
     ...
     5c0:	ff 35 b8 5f 00 00    	push   0x5fb8
     5c6:	e8 55 35 00 00       	call   3b20 <printf>
}
     ...
     5d8:	53                   	push   %ebx
     5d9:	68 74 4e 00 00       	push   $0x4e74
     5de:	ff 35 b8 5f 00 00    	push   0x5fb8
     5e4:	e8 37 35 00 00       	call   3b20 <printf>
      exit();
     5e9:	e8 dc 33 00 00       	call   39ca <exit>
      printf(stdout, "error: write bb %d new file failed\n", i);
     5ee:	83 ec 04             	sub    $0x4,%esp
     5f1:	53                   	push   %ebx
     5f2:	68 98 4e 00 00       	push   $0x4e98
     5f7:	ff 35 b8 5f 00 00    	push   0x5fb8
     5fd:	e8 1e 35 00 00       	call   3b20 <printf>
      exit();
     602:	e8 c3 33 00 00       	call   39ca <exit>
    printf(stdout, "error: open small failed!\n");
     607:	51                   	push   %ecx
     608:	51                   	push   %ecx
     609:	68 e6 3f 00 00       	push   $0x3fe6
     60e:	ff 35 b8 5f 00 00    	push   0x5fb8
     614:	e8 07 35 00 00       	call   3b20 <printf>
    exit();
     619:	e8 ac 33 00 00       	call   39ca <exit>
    printf(stdout, "read failed\n");
     61e:	52                   	push   %edx
     61f:	52                   	push   %edx
     620:	68 2d 43 00 00       	push   $0x432d
     625:	ff 35 b8 5f 00 00    	push   0x5fb8
     62b:	e8 f0 34 00 00       	call   3b20 <printf>
    exit();
     630:	e8 95 33 00 00       	call   39ca <exit>
    printf(stdout, "unlink small failed\n");
     635:	50                   	push   %eax
     636:	50                   	push   %eax
     637:	68 14 40 00 00       	push   $0x4014
     63c:	ff 35 b8 5f 00 00    	push   0x5fb8
     642:	e8 d9 34 00 00       	call   3b20 <printf>
    exit();
     647:	e8 7e 33 00 00       	call   39ca <exit>
    printf(stdout, "error: creat small failed!\n");
     64c:	50                   	push   %eax
     64d:	50                   	push   %eax
     64e:	68 90 3f 00 00       	push   $0x3f90
     653:	ff 35 b8 5f 00 00    	push   0x5fb8
     659:	e8 c2 34 00 00       	call   3b20 <printf>
    exit();
     65e:	e8 67 33 00 00       	call   39ca <exit>
...
00000670 <writetest1>:
{
  ...
  printf(stdout, "big files test\n");
     ...
     67d:	ff 35 b8 5f 00 00    	push   0x5fb8
     683:	e8 98 34 00 00       	call   3b20 <printf>
  fd = open("big", O_CREATE|O_RDWR);
     688:	58                   	pop    %eax
     689:	5a                   	pop    %edx
     68a:	68 02 02 00 00       	push   $0x202
     68f:	68 b7 40 00 00       	push   $0x40b7
     694:	e8 71 33 00 00       	call   3a0a <open>
  if(fd < 0){
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     6c3:	56                   	push   %esi
     6c4:	e8 21 33 00 00       	call   39ea <write>
  ...
  close(fd);
     ...
     6e5:	56                   	push   %esi
     6e6:	e8 07 33 00 00       	call   39f2 <close>
  fd = open("big", O_RDONLY);
     6eb:	5b                   	pop    %ebx
     6ec:	5e                   	pop    %esi
     6ed:	6a 00                	push   $0x0
     6ef:	68 b7 40 00 00       	push   $0x40b7
     6f4:	e8 11 33 00 00       	call   3a0a <open>
  if(fd < 0){
  ...
  n = 0;
    ...
    i = read(fd, buf, 512);
     ...
     734:	53                   	push   %ebx
     735:	e8 a8 32 00 00       	call   39e2 <read>
    if(i == 0){
  ...
  close(fd);
     ...
     750:	53                   	push   %ebx
     751:	e8 9c 32 00 00       	call   39f2 <close>
  if(unlink("big") < 0){
     756:	c7 04 24 b7 40 00 00 	movl   $0x40b7,(%esp)
     75d:	e8 b8 32 00 00       	call   3a1a <unlink>
  ...
  printf(stdout, "big files ok\n");
     ...
     775:	ff 35 b8 5f 00 00    	push   0x5fb8
     77b:	e8 a0 33 00 00       	call   3b20 <printf>
}
     ...
     793:	ff 35 b8 5f 00 00    	push   0x5fb8
     799:	e8 82 33 00 00       	call   3b20 <printf>
      exit();
     79e:	e8 27 32 00 00       	call   39ca <exit>
      printf(stdout, "read content of block %d is %d\n",
     7a3:	50                   	push   %eax
     7a4:	56                   	push   %esi
     7a5:	68 bc 4e 00 00       	push   $0x4ebc
     7aa:	ff 35 b8 5f 00 00    	push   0x5fb8
     7b0:	e8 6b 33 00 00       	call   3b20 <printf>
      exit();
     7b5:	e8 10 32 00 00       	call   39ca <exit>
      printf(stdout, "read failed %d\n", i);
     7ba:	83 ec 04             	sub    $0x4,%esp
     7bd:	50                   	push   %eax
     7be:	68 bb 40 00 00       	push   $0x40bb
     7c3:	ff 35 b8 5f 00 00    	push   0x5fb8
     7c9:	e8 52 33 00 00       	call   3b20 <printf>
      exit();
     7ce:	e8 f7 31 00 00       	call   39ca <exit>
        printf(stdout, "read only %d blocks from big", n);
     7d3:	52                   	push   %edx
     7d4:	68 8b 00 00 00       	push   $0x8b
     7d9:	68 9e 40 00 00       	push   $0x409e
     7de:	ff 35 b8 5f 00 00    	push   0x5fb8
     7e4:	e8 37 33 00 00       	call   3b20 <printf>
        exit();
     7e9:	e8 dc 31 00 00       	call   39ca <exit>
    printf(stdout, "error: open big failed!\n");
     7ee:	51                   	push   %ecx
     7ef:	51                   	push   %ecx
     7f0:	68 85 40 00 00       	push   $0x4085
     7f5:	ff 35 b8 5f 00 00    	push   0x5fb8
     7fb:	e8 20 33 00 00       	call   3b20 <printf>
    exit();
     800:	e8 c5 31 00 00       	call   39ca <exit>
    printf(stdout, "error: creat big failed!\n");
     805:	50                   	push   %eax
     806:	50                   	push   %eax
     807:	68 4d 40 00 00       	push   $0x404d
     80c:	ff 35 b8 5f 00 00    	push   0x5fb8
     812:	e8 09 33 00 00       	call   3b20 <printf>
    exit();
     817:	e8 ae 31 00 00       	call   39ca <exit>
    printf(stdout, "unlink big failed\n");
     81c:	50                   	push   %eax
     81d:	50                   	push   %eax
     81e:	68 cb 40 00 00       	push   $0x40cb
     823:	ff 35 b8 5f 00 00    	push   0x5fb8
     829:	e8 f2 32 00 00       	call   3b20 <printf>
    exit();
     82e:	e8 97 31 00 00       	call   39ca <exit>
     ...
     844:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     84c:	68 dc 4e 00 00       	push   $0x4edc
     851:	ff 35 b8 5f 00 00    	push   0x5fb8
     857:	e8 c4 32 00 00       	call   3b20 <printf>
  name[0] = 'a';
  ...
  for(i = 0; i < 52; i++){
    ...
    fd = open(name, O_CREATE|O_RDWR);
     ...
     886:	e8 7f 31 00 00       	call   3a0a <open>
    close(fd);
     88b:	89 04 24             	mov    %eax,(%esp)
     88e:	e8 5f 31 00 00       	call   39f2 <close>
  for(i = 0; i < 52; i++){
  ...
  for(i = 0; i < 52; i++){
    ...
    unlink(name);
     ...
     8c1:	e8 54 31 00 00       	call   3a1a <unlink>
  for(i = 0; i < 52; i++){
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     8d1:	68 08 4f 00 00       	push   $0x4f08
     8d6:	ff 35 b8 5f 00 00    	push   0x5fb8
     8dc:	e8 3f 32 00 00       	call   3b20 <printf>
}
...
000008f0 <dirtest>:
{
  ...
  printf(stdout, "mkdir test\n");
     ...
     8fb:	ff 35 b8 5f 00 00    	push   0x5fb8
     901:	e8 1a 32 00 00       	call   3b20 <printf>
  if(mkdir("dir0") < 0){
     906:	c7 04 24 f8 40 00 00 	movl   $0x40f8,(%esp)
     90d:	e8 20 31 00 00       	call   3a32 <mkdir>
  ...
  if(chdir("dir0") < 0){
     ...
     921:	e8 14 31 00 00       	call   3a3a <chdir>
  ...
  if(chdir("..") < 0){
     ...
     939:	e8 fc 30 00 00       	call   3a3a <chdir>
  ...
  if(unlink("dir0") < 0){
     ...
     94d:	e8 c8 30 00 00       	call   3a1a <unlink>
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     961:	ff 35 b8 5f 00 00    	push   0x5fb8
     967:	e8 b4 31 00 00       	call   3b20 <printf>
}
    ...
    printf(stdout, "mkdir failed\n");
     ...
     978:	ff 35 b8 5f 00 00    	push   0x5fb8
     97e:	e8 9d 31 00 00       	call   3b20 <printf>
    exit();
     983:	e8 42 30 00 00       	call   39ca <exit>
    printf(stdout, "unlink dir0 failed\n");
     988:	50                   	push   %eax
     989:	50                   	push   %eax
     98a:	68 21 41 00 00       	push   $0x4121
     98f:	ff 35 b8 5f 00 00    	push   0x5fb8
     995:	e8 86 31 00 00       	call   3b20 <printf>
    exit();
     99a:	e8 2b 30 00 00       	call   39ca <exit>
    printf(stdout, "chdir .. failed\n");
     99f:	52                   	push   %edx
     9a0:	52                   	push   %edx
     9a1:	68 10 41 00 00       	push   $0x4110
     9a6:	ff 35 b8 5f 00 00    	push   0x5fb8
     9ac:	e8 6f 31 00 00       	call   3b20 <printf>
    exit();
     9b1:	e8 14 30 00 00       	call   39ca <exit>
    printf(stdout, "chdir dir0 failed\n");
     9b6:	51                   	push   %ecx
     9b7:	51                   	push   %ecx
     9b8:	68 fd 40 00 00       	push   $0x40fd
     9bd:	ff 35 b8 5f 00 00    	push   0x5fb8
     9c3:	e8 58 31 00 00       	call   3b20 <printf>
    exit();
     9c8:	e8 fd 2f 00 00       	call   39ca <exit>
...
000009d0 <exectest>:
{
  ...
  printf(stdout, "exec test\n");
     ...
     9db:	ff 35 b8 5f 00 00    	push   0x5fb8
     9e1:	e8 3a 31 00 00       	call   3b20 <printf>
  if(exec("echo", echoargv) < 0){
     9e6:	5a                   	pop    %edx
     9e7:	59                   	pop    %ecx
     9e8:	68 bc 5f 00 00       	push   $0x5fbc
     9ed:	68 0d 3f 00 00       	push   $0x3f0d
     9f2:	e8 0b 30 00 00       	call   3a02 <exec>
    ...
    printf(stdout, "exec echo failed\n");
     ...
     a07:	ff 35 b8 5f 00 00    	push   0x5fb8
     a0d:	e8 0e 31 00 00       	call   3b20 <printf>
    exit();
     a12:	e8 b3 2f 00 00       	call   39ca <exit>
     ...
     a25:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  if(pid == 0){
    ...
    close(fds[1]);
     a5f:	e8 8e 2f 00 00       	call   39f2 <close>
    while((n = read(fds[0], buf, cc)) > 0){
     a64:	83 c4 10             	add    $0x10,%esp
     a67:	83 ec 04             	sub    $0x4,%esp
     a6a:	57                   	push   %edi
     a6b:	68 00 87 00 00       	push   $0x8700
     a70:	ff 75 e0             	push   -0x20(%ebp)
     a73:	e8 6a 2f 00 00       	call   39e2 <read>
     ...
     a87:	32 05 00 87 00 00    	xor    0x8700,%al
     ...
     aa0:	38 90 00 87 00 00    	cmp    %dl,0x8700(%eax)
     ...
     ac7:	68 7e 41 00 00       	push   $0x417e
     acc:	6a 01                	push   $0x1
     ace:	e8 4d 30 00 00       	call   3b20 <printf>
  ...
  seq = 0;
    ...
    close(fds[0]);
     ae6:	e8 07 2f 00 00       	call   39f2 <close>
     ...
     afb:	83 c0 01             	add    $0x1,%eax
        buf[i] = seq++;
     afe:	88 90 ff 86 00 00    	mov    %dl,0x86ff(%eax)
      for(i = 0; i < 1033; i++)
     ...
     b19:	68 00 87 00 00       	push   $0x8700
     b1e:	ff 75 e4             	push   -0x1c(%ebp)
     b21:	e8 c4 2e 00 00       	call   39ea <write>
    ...
    exit();
     b38:	e8 8d 2e 00 00       	call   39ca <exit>
    if(total != 5 * 1033){
    ...
    close(fds[0]);
     ...
     b4b:	e8 a2 2e 00 00       	call   39f2 <close>
    wait();
     b50:	e8 7d 2e 00 00       	call   39d2 <wait>
  printf(1, "pipe1 ok\n");
     b55:	5a                   	pop    %edx
     b56:	59                   	pop    %ecx
     b57:	68 a3 41 00 00       	push   $0x41a3
     b5c:	6a 01                	push   $0x1
     b5e:	e8 bd 2f 00 00       	call   3b20 <printf>
     b63:	83 c4 10             	add    $0x10,%esp
     b66:	e9 6b ff ff ff       	jmp    ad6 <pipe1+0xb6>
      printf(1, "pipe1 oops 3 total %d\n", total);
     b6b:	56                   	push   %esi
     b6c:	53                   	push   %ebx
     b6d:	68 8c 41 00 00       	push   $0x418c
     b72:	6a 01                	push   $0x1
     b74:	e8 a7 2f 00 00       	call   3b20 <printf>
      exit();
     b79:	e8 4c 2e 00 00       	call   39ca <exit>
    printf(1, "pipe() failed\n");
     b7e:	50                   	push   %eax
     b7f:	50                   	push   %eax
     b80:	68 61 41 00 00       	push   $0x4161
     b85:	6a 01                	push   $0x1
     b87:	e8 94 2f 00 00       	call   3b20 <printf>
    exit();
     b8c:	e8 39 2e 00 00       	call   39ca <exit>
    printf(1, "fork() failed\n");
     b91:	50                   	push   %eax
     b92:	50                   	push   %eax
     b93:	68 ad 41 00 00       	push   $0x41ad
     b98:	6a 01                	push   $0x1
     b9a:	e8 81 2f 00 00       	call   3b20 <printf>
    exit();
     b9f:	e8 26 2e 00 00       	call   39ca <exit>
        printf(1, "pipe1 oops 1\n");
     ba4:	57                   	push   %edi
     ba5:	57                   	push   %edi
     ba6:	68 70 41 00 00       	push   $0x4170
     bab:	6a 01                	push   $0x1
     bad:	e8 6e 2f 00 00       	call   3b20 <printf>
        exit();
     bb2:	e8 13 2e 00 00       	call   39ca <exit>
...
00000bc0 <preempt>:
{
  ...
  printf(1, "preempt: ");
     bc9:	68 bc 41 00 00       	push   $0x41bc
     bce:	6a 01                	push   $0x1
     bd0:	e8 4b 2f 00 00       	call   3b20 <printf>
  pid1 = fork();
     bd5:	e8 e8 2d 00 00       	call   39c2 <fork>
  if(pid1 == 0)
  ...
  pid2 = fork();
     bea:	e8 d3 2d 00 00       	call   39c2 <fork>
  ...
  pipe(pfds);
     ...
     c06:	50                   	push   %eax
     c07:	e8 ce 2d 00 00       	call   39da <pipe>
  pid3 = fork();
     c0c:	e8 b1 2d 00 00       	call   39c2 <fork>
  if(pid3 == 0){
  ...
  if(pid3 == 0){
    ...
    close(pfds[0]);
     ...
     c20:	e8 cd 2d 00 00       	call   39f2 <close>
    if(write(pfds[1], "x", 1) != 1)
     c25:	83 c4 0c             	add    $0xc,%esp
     c28:	6a 01                	push   $0x1
     c2a:	68 81 47 00 00       	push   $0x4781
     c2f:	ff 75 e4             	push   -0x1c(%ebp)
     c32:	e8 b3 2d 00 00       	call   39ea <write>
    ...
    close(pfds[1]);
     ...
     c49:	e8 a4 2d 00 00       	call   39f2 <close>
  ...
  close(pfds[1]);
     ...
     c5e:	e8 8f 2d 00 00       	call   39f2 <close>
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     c63:	83 c4 0c             	add    $0xc,%esp
     c66:	68 00 20 00 00       	push   $0x2000
     c6b:	68 00 87 00 00       	push   $0x8700
     c70:	ff 75 e0             	push   -0x20(%ebp)
     c73:	e8 6a 2d 00 00       	call   39e2 <read>
  ...
  close(pfds[0]);
     ...
     c86:	e8 67 2d 00 00       	call   39f2 <close>
  printf(1, "kill... ");
     c8b:	58                   	pop    %eax
     c8c:	5a                   	pop    %edx
     c8d:	68 ed 41 00 00       	push   $0x41ed
     c92:	6a 01                	push   $0x1
     c94:	e8 87 2e 00 00       	call   3b20 <printf>
  kill(pid1);
     c99:	89 1c 24             	mov    %ebx,(%esp)
     c9c:	e8 59 2d 00 00       	call   39fa <kill>
  kill(pid2);
     ca1:	89 34 24             	mov    %esi,(%esp)
     ca4:	e8 51 2d 00 00       	call   39fa <kill>
  kill(pid3);
     ca9:	89 3c 24             	mov    %edi,(%esp)
     cac:	e8 49 2d 00 00       	call   39fa <kill>
  printf(1, "wait... ");
     cb1:	59                   	pop    %ecx
     cb2:	5b                   	pop    %ebx
     cb3:	68 f6 41 00 00       	push   $0x41f6
     cb8:	6a 01                	push   $0x1
     cba:	e8 61 2e 00 00       	call   3b20 <printf>
  wait();
     cbf:	e8 0e 2d 00 00       	call   39d2 <wait>
  wait();
     cc4:	e8 09 2d 00 00       	call   39d2 <wait>
  wait();
     cc9:	e8 04 2d 00 00       	call   39d2 <wait>
  printf(1, "preempt ok\n");
     cce:	5e                   	pop    %esi
     ccf:	5f                   	pop    %edi
     cd0:	68 ff 41 00 00       	push   $0x41ff
     cd5:	6a 01                	push   $0x1
     cd7:	e8 44 2e 00 00       	call   3b20 <printf>
    ...
    printf(1, "preempt read error");
     ...
     cea:	68 da 41 00 00       	push   $0x41da
     cef:	6a 01                	push   $0x1
     cf1:	e8 2a 2e 00 00       	call   3b20 <printf>
     cf6:	83 c4 10             	add    $0x10,%esp
     cf9:	eb e4                	jmp    cdf <preempt+0x11f>
      printf(1, "preempt write error");
     cfb:	83 ec 08             	sub    $0x8,%esp
     cfe:	68 c6 41 00 00       	push   $0x41c6
     d03:	6a 01                	push   $0x1
     d05:	e8 16 2e 00 00       	call   3b20 <printf>
...
00000d20 <exitwait>:
{
    ...
    if(pid){
     d30:	74 68                	je     d9a <exitwait+0x7a>
      if(wait() != pid){
     d32:	e8 9b 2c 00 00       	call   39d2 <wait>
  ...
  for(i = 0; i < 100; i++){
    ...
    pid = fork();
     d40:	e8 7d 2c 00 00       	call   39c2 <fork>
    ...
    if(pid < 0){
     ...
     d4e:	68 69 4d 00 00       	push   $0x4d69
     d53:	6a 01                	push   $0x1
     d55:	e8 c6 2d 00 00       	call   3b20 <printf>
      return;
     ...
     d6b:	68 0b 42 00 00       	push   $0x420b
     d70:	6a 01                	push   $0x1
     d72:	e8 a9 2d 00 00       	call   3b20 <printf>
        return;
  ...
  printf(1, "exitwait ok\n");
     ...
     d84:	68 1b 42 00 00       	push   $0x421b
     d89:	6a 01                	push   $0x1
     d8b:	e8 90 2d 00 00       	call   3b20 <printf>
     ...
     d99:	c3                   	ret
      exit();
     d9a:	e8 2b 2c 00 00       	call   39ca <exit>
     d9f:	90                   	nop
...
00000da0 <mem>:
{
  ...
  printf(1, "mem test\n");
     ...
     daa:	68 28 42 00 00       	push   $0x4228
     daf:	6a 01                	push   $0x1
     db1:	e8 6a 2d 00 00       	call   3b20 <printf>
  ppid = getpid();
     db6:	e8 8f 2c 00 00       	call   3a4a <getpid>
     dbb:	89 c3                	mov    %eax,%ebx
  if((pid = fork()) == 0){
     dbd:	e8 00 2c 00 00       	call   39c2 <fork>
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     ddc:	e8 5f 2f 00 00       	call   3d40 <malloc>
    ...
    while(m1){
     ...
     df5:	8b 36                	mov    (%esi),%esi
      free(m1);
     df7:	50                   	push   %eax
     df8:	e8 b3 2e 00 00       	call   3cb0 <free>
    while(m1){
    ...
    m1 = malloc(1024*20);
     ...
     e0c:	e8 2f 2f 00 00       	call   3d40 <malloc>
    if(m1 == 0){
    ...
    free(m1);
     ...
     e1b:	50                   	push   %eax
     e1c:	e8 8f 2e 00 00       	call   3cb0 <free>
    printf(1, "mem ok\n");
     e21:	58                   	pop    %eax
     e22:	5a                   	pop    %edx
     e23:	68 4c 42 00 00       	push   $0x424c
     e28:	6a 01                	push   $0x1
     e2a:	e8 f1 2c 00 00       	call   3b20 <printf>
    exit();
     e2f:	e8 96 2b 00 00       	call   39ca <exit>
     e34:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      printf(1, "couldn't allocate mem?!!\n");
     e38:	83 ec 08             	sub    $0x8,%esp
     e3b:	68 32 42 00 00       	push   $0x4232
     e40:	6a 01                	push   $0x1
     e42:	e8 d9 2c 00 00       	call   3b20 <printf>
      kill(ppid);
     e47:	89 1c 24             	mov    %ebx,(%esp)
     e4a:	e8 ab 2b 00 00       	call   39fa <kill>
      exit();
     e4f:	e8 76 2b 00 00       	call   39ca <exit>
     ...
     e5d:	5d                   	pop    %ebp
    wait();
     e5e:	e9 6f 2b 00 00       	jmp    39d2 <wait>
...
00000e70 <sharedfd>:
{
  ...
  printf(1, "sharedfd test\n");
     e79:	68 54 42 00 00       	push   $0x4254
     e7e:	6a 01                	push   $0x1
     e80:	e8 9b 2c 00 00       	call   3b20 <printf>
  unlink("sharedfd");
     e85:	c7 04 24 63 42 00 00 	movl   $0x4263,(%esp)
     e8c:	e8 89 2b 00 00       	call   3a1a <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     e91:	5b                   	pop    %ebx
     e92:	5e                   	pop    %esi
     e93:	68 02 02 00 00       	push   $0x202
     e98:	68 63 42 00 00       	push   $0x4263
     e9d:	e8 68 2b 00 00       	call   3a0a <open>
  if(fd < 0){
  ...
  pid = fork();
     eb7:	e8 06 2b 00 00       	call   39c2 <fork>
  memset(buf, pid==0?'c':'p', sizeof(buf));
  ...
  if(pid == 0)
    ...
    wait();
     f16:	e8 b7 2a 00 00       	call   39d2 <wait>
  close(fd);
  ...
  close(fd);
     ...
     f24:	e8 c9 2a 00 00       	call   39f2 <close>
  fd = open("sharedfd", 0);
     f29:	58                   	pop    %eax
     f2a:	5a                   	pop    %edx
     f2b:	6a 00                	push   $0x0
     f2d:	68 63 42 00 00       	push   $0x4263
     f32:	e8 d3 2a 00 00       	call   3a0a <open>
  if(fd < 0){
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f5c:	e8 81 2a 00 00       	call   39e2 <read>
  ...
  close(fd);
     ...
     f96:	e8 57 2a 00 00       	call   39f2 <close>
  unlink("sharedfd");
     f9b:	c7 04 24 63 42 00 00 	movl   $0x4263,(%esp)
     fa2:	e8 73 2a 00 00       	call   3a1a <unlink>
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     ...
     fc0:	68 6c 42 00 00       	push   $0x426c
     fc5:	6a 01                	push   $0x1
     fc7:	e8 54 2b 00 00       	call   3b20 <printf>
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     ...
     fda:	68 30 4f 00 00       	push   $0x4f30
     fdf:	6a 01                	push   $0x1
     fe1:	e8 3a 2b 00 00       	call   3b20 <printf>
    return;
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     ...
     ff4:	68 7c 4f 00 00       	push   $0x4f7c
     ff9:	6a 01                	push   $0x1
     ffb:	e8 20 2b 00 00       	call   3b20 <printf>
    return;
    ...
    100a:	c3                   	ret
    exit();
    100b:	e8 ba 29 00 00       	call   39ca <exit>
    printf(1, "sharedfd oops %d %d\n", nc, np);
    1010:	53                   	push   %ebx
    1011:	52                   	push   %edx
    1012:	68 79 42 00 00       	push   $0x4279
    1017:	6a 01                	push   $0x1
    1019:	e8 02 2b 00 00       	call   3b20 <printf>
    exit();
    101e:	e8 a7 29 00 00       	call   39ca <exit>
    ...
    1036:	31 db                	xor    %ebx,%ebx
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    103b:	c7 45 d8 8e 42 00 00 	movl   $0x428e,-0x28(%ebp)
    1042:	c7 45 dc d7 43 00 00 	movl   $0x43d7,-0x24(%ebp)
    1049:	c7 45 e0 db 43 00 00 	movl   $0x43db,-0x20(%ebp)
    1050:	c7 45 e4 91 42 00 00 	movl   $0x4291,-0x1c(%ebp)
  printf(1, "fourfiles test\n");
    1057:	68 94 42 00 00       	push   $0x4294
    105c:	6a 01                	push   $0x1
    105e:	e8 bd 2a 00 00       	call   3b20 <printf>
    ...
    106d:	56                   	push   %esi
    106e:	e8 a7 29 00 00       	call   3a1a <unlink>
    pid = fork();
    1073:	e8 4a 29 00 00       	call   39c2 <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    1091:	e8 3c 29 00 00       	call   39d2 <wait>
    1096:	31 f6                	xor    %esi,%esi
    1098:	e8 35 29 00 00       	call   39d2 <wait>
    109d:	e8 30 29 00 00       	call   39d2 <wait>
    10a2:	e8 2b 29 00 00       	call   39d2 <wait>
    fname = names[i];
    ...
    10b8:	6a 00                	push   $0x0
    10ba:	50                   	push   %eax
    10bb:	e8 4a 29 00 00       	call   3a0a <open>
    while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    10e0:	e8 fd 28 00 00       	call   39e2 <read>
    ...
    10f2:	0f be 8a 00 87 00 00 	movsbl 0x8700(%edx),%ecx
    ...
    111a:	51                   	push   %ecx
    111b:	e8 d2 28 00 00       	call   39f2 <close>
    if(total != 12*500){
    ...
    1135:	e8 e0 28 00 00       	call   3a1a <unlink>
  for(i = 0; i < 2; i++){
  ...
  printf(1, "fourfiles ok\n");
    ...
    114e:	68 d2 42 00 00       	push   $0x42d2
    1153:	6a 01                	push   $0x1
    1155:	e8 c6 29 00 00       	call   3b20 <printf>
}
    ...
    1168:	68 b5 42 00 00       	push   $0x42b5
    116d:	6a 01                	push   $0x1
    116f:	e8 ac 29 00 00       	call   3b20 <printf>
          exit();
    1174:	e8 51 28 00 00       	call   39ca <exit>
      fd = open(fname, O_CREATE | O_RDWR);
    1179:	83 ec 08             	sub    $0x8,%esp
    117c:	68 02 02 00 00       	push   $0x202
    1181:	56                   	push   %esi
    1182:	e8 83 28 00 00       	call   3a0a <open>
      if(fd < 0){
    ...
    11a1:	68 00 87 00 00       	push   $0x8700
    ...
    11b6:	68 00 87 00 00       	push   $0x8700
    11bb:	56                   	push   %esi
    11bc:	e8 29 28 00 00       	call   39ea <write>
    ...
    11ce:	75 de                	jne    11ae <fourfiles+0x17e>
      exit();
    11d0:	e8 f5 27 00 00       	call   39ca <exit>
        printf(1, "create failed\n");
    11d5:	51                   	push   %ecx
    11d6:	51                   	push   %ecx
    11d7:	68 2f 45 00 00       	push   $0x452f
    11dc:	6a 01                	push   $0x1
    11de:	e8 3d 29 00 00       	call   3b20 <printf>
        exit();
    11e3:	e8 e2 27 00 00       	call   39ca <exit>
    11e8:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
    11ef:	00 
      printf(1, "fork failed\n");
    11f0:	83 ec 08             	sub    $0x8,%esp
    11f3:	68 69 4d 00 00       	push   $0x4d69
    11f8:	6a 01                	push   $0x1
    11fa:	e8 21 29 00 00       	call   3b20 <printf>
      exit();
    11ff:	e8 c6 27 00 00       	call   39ca <exit>
      printf(1, "wrong length %d\n", total);
    1204:	50                   	push   %eax
    1205:	57                   	push   %edi
    1206:	68 c1 42 00 00       	push   $0x42c1
    120b:	6a 01                	push   $0x1
    120d:	e8 0e 29 00 00       	call   3b20 <printf>
      exit();
    1212:	e8 b3 27 00 00       	call   39ca <exit>
          printf(1, "write failed %d\n", n);
    1217:	52                   	push   %edx
    1218:	50                   	push   %eax
    1219:	68 a4 42 00 00       	push   $0x42a4
    121e:	6a 01                	push   $0x1
    1220:	e8 fb 28 00 00       	call   3b20 <printf>
          exit();
    1225:	e8 a0 27 00 00       	call   39ca <exit>
    ...
    1235:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "createdelete test\n");
    123b:	68 e0 42 00 00       	push   $0x42e0
    1240:	6a 01                	push   $0x1
    1242:	e8 d9 28 00 00       	call   3b20 <printf>
    1247:	83 c4 10             	add    $0x10,%esp
    pid = fork();
    124a:	e8 73 27 00 00       	call   39c2 <fork>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    1267:	e8 66 27 00 00       	call   39d2 <wait>
  for(i = 0; i < N; i++){
    126c:	31 ff                	xor    %edi,%edi
    126e:	8d 75 c8             	lea    -0x38(%ebp),%esi
    wait();
    1271:	e8 5c 27 00 00       	call   39d2 <wait>
    1276:	e8 57 27 00 00       	call   39d2 <wait>
    127b:	e8 52 27 00 00       	call   39d2 <wait>
  ...
  for(i = 0; i < N; i++){
    ...
    12b0:	6a 00                	push   $0x0
    12b2:	56                   	push   %esi
    12b3:	e8 52 27 00 00       	call   3a0a <open>
      if((i == 0 || i >= N/2) && fd < 0){
    ...
    12cc:	50                   	push   %eax
    12cd:	e8 20 27 00 00       	call   39f2 <close>
  ...
  for(i = 0; i < N; i++){
    ...
    1307:	88 45 c9             	mov    %al,-0x37(%ebp)
      unlink(name);
    130a:	56                   	push   %esi
    130b:	e8 0a 27 00 00       	call   3a1a <unlink>
    for(pi = 0; pi < 4; pi++){
  ...
  printf(1, "createdelete ok\n");
    ...
    1329:	6a 01                	push   $0x1
    132b:	e8 f0 27 00 00       	call   3b20 <printf>
}
    ...
    1344:	50                   	push   %eax
    1345:	56                   	push   %esi
    1346:	68 cc 4f 00 00       	push   $0x4fcc
    134b:	6a 01                	push   $0x1
    134d:	e8 ce 27 00 00       	call   3b20 <printf>
        exit();
    1352:	e8 73 26 00 00       	call   39ca <exit>
    ...
    137e:	56                   	push   %esi
    137f:	e8 86 26 00 00       	call   3a0a <open>
        if(fd < 0){
    ...
    1392:	50                   	push   %eax
    1393:	e8 5a 26 00 00       	call   39f2 <close>
        if(i > 0 && (i % 2 ) == 0){
    ...
    13aa:	75 c4                	jne    1370 <createdelete+0x140>
      exit();
    13ac:	e8 19 26 00 00       	call   39ca <exit>
    ...
    13c9:	88 45 c9             	mov    %al,-0x37(%ebp)
          if(unlink(name) < 0){
    13cc:	56                   	push   %esi
    13cd:	e8 48 26 00 00       	call   3a1a <unlink>
    ...
    13d9:	52                   	push   %edx
    13da:	52                   	push   %edx
    13db:	68 e1 3e 00 00       	push   $0x3ee1
    13e0:	6a 01                	push   $0x1
    13e2:	e8 39 27 00 00       	call   3b20 <printf>
            exit();
    13e7:	e8 de 25 00 00       	call   39ca <exit>
    13ec:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        printf(1, "oops createdelete %s didn't exist\n", name);
    13f0:	83 ec 04             	sub    $0x4,%esp
    13f3:	56                   	push   %esi
    13f4:	68 a8 4f 00 00       	push   $0x4fa8
    13f9:	6a 01                	push   $0x1
    13fb:	e8 20 27 00 00       	call   3b20 <printf>
        exit();
    1400:	e8 c5 25 00 00       	call   39ca <exit>
      printf(1, "fork failed\n");
    1405:	83 ec 08             	sub    $0x8,%esp
    1408:	68 69 4d 00 00       	push   $0x4d69
    140d:	6a 01                	push   $0x1
    140f:	e8 0c 27 00 00       	call   3b20 <printf>
      exit();
    1414:	e8 b1 25 00 00       	call   39ca <exit>
          printf(1, "create failed\n");
    1419:	83 ec 08             	sub    $0x8,%esp
    141c:	68 2f 45 00 00       	push   $0x452f
    1421:	6a 01                	push   $0x1
    1423:	e8 f8 26 00 00       	call   3b20 <printf>
          exit();
    1428:	e8 9d 25 00 00       	call   39ca <exit>
...
00001430 <unlinkread>:
{
  ...
  printf(1, "unlinkread test\n");
    ...
    143d:	6a 01                	push   $0x1
    143f:	e8 dc 26 00 00       	call   3b20 <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    1444:	5b                   	pop    %ebx
    1445:	5e                   	pop    %esi
    1446:	68 02 02 00 00       	push   $0x202
    144b:	68 15 43 00 00       	push   $0x4315
    1450:	e8 b5 25 00 00       	call   3a0a <open>
  if(fd < 0){
  ...
  write(fd, "hello", 5);
    ...
    146c:	50                   	push   %eax
    146d:	e8 78 25 00 00       	call   39ea <write>
  close(fd);
    1472:	89 1c 24             	mov    %ebx,(%esp)
    1475:	e8 78 25 00 00       	call   39f2 <close>
  fd = open("unlinkread", O_RDWR);
    147a:	58                   	pop    %eax
    147b:	5a                   	pop    %edx
    147c:	6a 02                	push   $0x2
    147e:	68 15 43 00 00       	push   $0x4315
    1483:	e8 82 25 00 00       	call   3a0a <open>
  if(fd < 0){
  ...
  if(unlink("unlinkread") != 0){
    ...
    149d:	e8 78 25 00 00       	call   3a1a <unlink>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    14ba:	e8 4b 25 00 00       	call   3a0a <open>
  write(fd1, "yyy", 3);
  ...
  close(fd);
    ...
    151c:	53                   	push   %ebx
    151d:	e8 d0 24 00 00       	call   39f2 <close>
  unlink("unlinkread");
    1522:	c7 04 24 15 43 00 00 	movl   $0x4315,(%esp)
    1529:	e8 ec 24 00 00       	call   3a1a <unlink>
  printf(1, "unlinkread ok\n");
    152e:	58                   	pop    %eax
    152f:	5a                   	pop    %edx
    1530:	68 bd 43 00 00       	push   $0x43bd
    1535:	6a 01                	push   $0x1
    1537:	e8 e4 25 00 00       	call   3b20 <printf>
}
    ...
    154d:	6a 01                	push   $0x1
    154f:	e8 cc 25 00 00       	call   3b20 <printf>
    exit();
    1554:	e8 71 24 00 00       	call   39ca <exit>
    printf(1, "unlinkread write failed\n");
    1559:	51                   	push   %ecx
    155a:	51                   	push   %ecx
    155b:	68 a4 43 00 00       	push   $0x43a4
    1560:	6a 01                	push   $0x1
    1562:	e8 b9 25 00 00       	call   3b20 <printf>
    exit();
    1567:	e8 5e 24 00 00       	call   39ca <exit>
    printf(1, "unlinkread wrong data\n");
    156c:	53                   	push   %ebx
    156d:	53                   	push   %ebx
    156e:	68 8d 43 00 00       	push   $0x438d
    1573:	6a 01                	push   $0x1
    1575:	e8 a6 25 00 00       	call   3b20 <printf>
    exit();
    157a:	e8 4b 24 00 00       	call   39ca <exit>
    printf(1, "unlinkread read failed");
    157f:	56                   	push   %esi
    1580:	56                   	push   %esi
    1581:	68 76 43 00 00       	push   $0x4376
    1586:	6a 01                	push   $0x1
    1588:	e8 93 25 00 00       	call   3b20 <printf>
    exit();
    158d:	e8 38 24 00 00       	call   39ca <exit>
    printf(1, "unlink unlinkread failed\n");
    1592:	50                   	push   %eax
    1593:	50                   	push   %eax
    1594:	68 58 43 00 00       	push   $0x4358
    1599:	6a 01                	push   $0x1
    159b:	e8 80 25 00 00       	call   3b20 <printf>
    exit();
    15a0:	e8 25 24 00 00       	call   39ca <exit>
    printf(1, "open unlinkread failed\n");
    15a5:	50                   	push   %eax
    15a6:	50                   	push   %eax
    15a7:	68 40 43 00 00       	push   $0x4340
    15ac:	6a 01                	push   $0x1
    15ae:	e8 6d 25 00 00       	call   3b20 <printf>
    exit();
    15b3:	e8 12 24 00 00       	call   39ca <exit>
...
000015c0 <linktest>:
{
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1613:	50                   	push   %eax
    1614:	e8 d1 23 00 00       	call   39ea <write>
  ...
  close(fd);
    ...
    1628:	53                   	push   %ebx
    1629:	e8 c4 23 00 00       	call   39f2 <close>
  if(link("lf1", "lf2") < 0){
    162e:	5b                   	pop    %ebx
    162f:	58                   	pop    %eax
    1630:	68 da 43 00 00       	push   $0x43da
    1635:	68 d6 43 00 00       	push   $0x43d6
    163a:	e8 eb 23 00 00       	call   3a2a <link>
  ...
  unlink("lf1");
    ...
    1652:	e8 c3 23 00 00       	call   3a1a <unlink>
  if(open("lf1", 0) >= 0){
    1657:	58                   	pop    %eax
    1658:	5a                   	pop    %edx
    1659:	6a 00                	push   $0x0
    165b:	68 d6 43 00 00       	push   $0x43d6
    1660:	e8 a5 23 00 00       	call   3a0a <open>
  ...
  fd = open("lf2", 0);
    ...
    167a:	e8 8b 23 00 00       	call   3a0a <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1694:	68 00 87 00 00       	push   $0x8700
    1699:	50                   	push   %eax
    169a:	e8 43 23 00 00       	call   39e2 <read>
  ...
  close(fd);
    ...
    16ae:	53                   	push   %ebx
    16af:	e8 3e 23 00 00       	call   39f2 <close>
  if(link("lf2", "lf2") >= 0){
    16b4:	58                   	pop    %eax
    16b5:	5a                   	pop    %edx
    16b6:	68 da 43 00 00       	push   $0x43da
    16bb:	68 da 43 00 00       	push   $0x43da
    16c0:	e8 65 23 00 00       	call   3a2a <link>
  ...
  unlink("lf2");
    ...
    16d8:	e8 3d 23 00 00       	call   3a1a <unlink>
  if(link("lf2", "lf1") >= 0){
    16dd:	59                   	pop    %ecx
    16de:	5b                   	pop    %ebx
    16df:	68 d6 43 00 00       	push   $0x43d6
    16e4:	68 da 43 00 00       	push   $0x43da
    16e9:	e8 3c 23 00 00       	call   3a2a <link>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1702:	e8 23 23 00 00       	call   3a2a <link>
  ...
  printf(1, "linktest ok\n");
    ...
    1716:	6a 01                	push   $0x1
    1718:	e8 03 24 00 00       	call   3b20 <printf>
}
    ...
    172c:	6a 01                	push   $0x1
    172e:	e8 ed 23 00 00       	call   3b20 <printf>
    exit();
    1733:	e8 92 22 00 00       	call   39ca <exit>
    printf(1, "link . lf1 succeeded! oops\n");
    1738:	50                   	push   %eax
    1739:	50                   	push   %eax
    173a:	68 58 44 00 00       	push   $0x4458
    173f:	6a 01                	push   $0x1
    1741:	e8 da 23 00 00       	call   3b20 <printf>
    exit();
    1746:	e8 7f 22 00 00       	call   39ca <exit>
    printf(1, "link non-existant succeeded! oops\n");
    174b:	52                   	push   %edx
    174c:	52                   	push   %edx
    174d:	68 14 50 00 00       	push   $0x5014
    1752:	6a 01                	push   $0x1
    1754:	e8 c7 23 00 00       	call   3b20 <printf>
    exit();
    1759:	e8 6c 22 00 00       	call   39ca <exit>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    175e:	50                   	push   %eax
    175f:	50                   	push   %eax
    1760:	68 3a 44 00 00       	push   $0x443a
    1765:	6a 01                	push   $0x1
    1767:	e8 b4 23 00 00       	call   3b20 <printf>
    exit();
    176c:	e8 59 22 00 00       	call   39ca <exit>
    printf(1, "read lf2 failed\n");
    1771:	51                   	push   %ecx
    1772:	51                   	push   %ecx
    1773:	68 29 44 00 00       	push   $0x4429
    1778:	6a 01                	push   $0x1
    177a:	e8 a1 23 00 00       	call   3b20 <printf>
    exit();
    177f:	e8 46 22 00 00       	call   39ca <exit>
    printf(1, "open lf2 failed\n");
    1784:	53                   	push   %ebx
    1785:	53                   	push   %ebx
    1786:	68 18 44 00 00       	push   $0x4418
    178b:	6a 01                	push   $0x1
    178d:	e8 8e 23 00 00       	call   3b20 <printf>
    exit();
    1792:	e8 33 22 00 00       	call   39ca <exit>
    printf(1, "unlinked lf1 but it is still there!\n");
    1797:	50                   	push   %eax
    1798:	50                   	push   %eax
    1799:	68 ec 4f 00 00       	push   $0x4fec
    179e:	6a 01                	push   $0x1
    17a0:	e8 7b 23 00 00       	call   3b20 <printf>
    exit();
    17a5:	e8 20 22 00 00       	call   39ca <exit>
    printf(1, "link lf1 lf2 failed\n");
    17aa:	51                   	push   %ecx
    17ab:	51                   	push   %ecx
    17ac:	68 03 44 00 00       	push   $0x4403
    17b1:	6a 01                	push   $0x1
    17b3:	e8 68 23 00 00       	call   3b20 <printf>
    exit();
    17b8:	e8 0d 22 00 00       	call   39ca <exit>
    printf(1, "write lf1 failed\n");
    17bd:	50                   	push   %eax
    17be:	50                   	push   %eax
    17bf:	68 f1 43 00 00       	push   $0x43f1
    17c4:	6a 01                	push   $0x1
    17c6:	e8 55 23 00 00       	call   3b20 <printf>
    exit();
    17cb:	e8 fa 21 00 00       	call   39ca <exit>
    ...
    17d5:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "concreate test\n");
    17de:	68 81 44 00 00       	push   $0x4481
    17e3:	6a 01                	push   $0x1
    17e5:	e8 36 23 00 00       	call   3b20 <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    1819:	53                   	push   %ebx
    181a:	e8 eb 21 00 00       	call   3a0a <open>
      if(fd < 0){
  ...
  for(i = 0; i < 40; i++){
    1829:	83 c6 01             	add    $0x1,%esi
      close(fd);
    182c:	50                   	push   %eax
    182d:	e8 c0 21 00 00       	call   39f2 <close>
    1832:	83 c4 10             	add    $0x10,%esp
      wait();
    1835:	e8 98 21 00 00       	call   39d2 <wait>
  for(i = 0; i < 40; i++){
    ...
    unlink(file);
    184c:	53                   	push   %ebx
    184d:	e8 c8 21 00 00       	call   3a1a <unlink>
    pid = fork();
    1852:	e8 6b 21 00 00       	call   39c2 <fork>
    if(pid && (i % 3) == 1){
    ...
    1878:	53                   	push   %ebx
    1879:	e8 8c 21 00 00       	call   3a0a <open>
      if(fd < 0){
    ...
    188c:	53                   	push   %ebx
    188d:	68 94 44 00 00       	push   $0x4494
    1892:	6a 01                	push   $0x1
    1894:	e8 87 22 00 00       	call   3b20 <printf>
        exit();
    1899:	e8 2c 21 00 00       	call   39ca <exit>
  ...
  for(i = 0; i < 40; i++){
    18a3:	83 c6 01             	add    $0x1,%esi
      link("C0", file);
    18a6:	53                   	push   %ebx
    18a7:	68 91 44 00 00       	push   $0x4491
    18ac:	e8 79 21 00 00       	call   3a2a <link>
    18b1:	83 c4 10             	add    $0x10,%esp
      wait();
    18b4:	e8 19 21 00 00       	call   39d2 <wait>
  for(i = 0; i < 40; i++){
  ...
  fd = open(".", 0);
    ...
    18d3:	5f                   	pop    %edi
    18d4:	6a 00                	push   $0x0
    18d6:	68 9e 46 00 00       	push   $0x469e
    18db:	8d 7d b0             	lea    -0x50(%ebp),%edi
    18de:	e8 27 21 00 00       	call   3a0a <open>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    18f5:	57                   	push   %edi
    18f6:	56                   	push   %esi
    18f7:	e8 e6 20 00 00       	call   39e2 <read>
    ...
    1943:	53                   	push   %ebx
    1944:	68 91 44 00 00       	push   $0x4491
    1949:	e8 dc 20 00 00       	call   3a2a <link>
    194e:	83 c4 10             	add    $0x10,%esp
      exit();
    1951:	e8 74 20 00 00       	call   39ca <exit>
  ...
  close(fd);
    ...
    1963:	56                   	push   %esi
    1964:	e8 89 20 00 00       	call   39f2 <close>
  if(n != 40){
  ...
  for(i = 0; i < 40; i++){
    ...
    198c:	53                   	push   %ebx
    198d:	e8 88 20 00 00       	call   3a1a <unlink>
      unlink(file);
    1992:	89 1c 24             	mov    %ebx,(%esp)
    1995:	e8 80 20 00 00       	call   3a1a <unlink>
      unlink(file);
    199a:	89 1c 24             	mov    %ebx,(%esp)
    199d:	e8 78 20 00 00       	call   3a1a <unlink>
      unlink(file);
    19a2:	89 1c 24             	mov    %ebx,(%esp)
    19a5:	e8 70 20 00 00       	call   3a1a <unlink>
    19aa:	83 c4 10             	add    $0x10,%esp
    if(pid == 0)
    19ad:	85 ff                	test   %edi,%edi
    19af:	74 a0                	je     1951 <concreate+0x181>
      wait();
    19b1:	e8 1c 20 00 00       	call   39d2 <wait>
  for(i = 0; i < 40; i++){
    ...
    pid = fork();
    19c8:	e8 f5 1f 00 00       	call   39c2 <fork>
    ...
    19f4:	6a 00                	push   $0x0
    19f6:	53                   	push   %ebx
    19f7:	e8 0e 20 00 00       	call   3a0a <open>
    19fc:	89 04 24             	mov    %eax,(%esp)
    19ff:	e8 ee 1f 00 00       	call   39f2 <close>
      close(open(file, 0));
    1a04:	58                   	pop    %eax
    1a05:	5a                   	pop    %edx
    1a06:	6a 00                	push   $0x0
    1a08:	53                   	push   %ebx
    1a09:	e8 fc 1f 00 00       	call   3a0a <open>
    1a0e:	89 04 24             	mov    %eax,(%esp)
    1a11:	e8 dc 1f 00 00       	call   39f2 <close>
      close(open(file, 0));
    1a16:	59                   	pop    %ecx
    1a17:	58                   	pop    %eax
    1a18:	6a 00                	push   $0x0
    1a1a:	53                   	push   %ebx
    1a1b:	e8 ea 1f 00 00       	call   3a0a <open>
    1a20:	89 04 24             	mov    %eax,(%esp)
    1a23:	e8 ca 1f 00 00       	call   39f2 <close>
      close(open(file, 0));
    1a28:	58                   	pop    %eax
    1a29:	5a                   	pop    %edx
    1a2a:	6a 00                	push   $0x0
    1a2c:	53                   	push   %ebx
    1a2d:	e8 d8 1f 00 00       	call   3a0a <open>
    1a32:	89 04 24             	mov    %eax,(%esp)
    1a35:	e8 b8 1f 00 00       	call   39f2 <close>
  ...
  printf(1, "concreate ok\n");
    ...
    1a4b:	68 e6 44 00 00       	push   $0x44e6
    1a50:	6a 01                	push   $0x1
    1a52:	e8 c9 20 00 00       	call   3b20 <printf>
}
    ...
    1a62:	68 69 4d 00 00       	push   $0x4d69
    1a67:	6a 01                	push   $0x1
    1a69:	e8 b2 20 00 00       	call   3b20 <printf>
      exit();
    1a6e:	e8 57 1f 00 00       	call   39ca <exit>
      close(fd);
    1a73:	83 ec 0c             	sub    $0xc,%esp
    1a76:	50                   	push   %eax
    1a77:	e8 76 1f 00 00       	call   39f2 <close>
    ...
    1a8a:	50                   	push   %eax
    1a8b:	68 b0 44 00 00       	push   $0x44b0
    1a90:	6a 01                	push   $0x1
    1a92:	e8 89 20 00 00       	call   3b20 <printf>
        exit();
    1a97:	e8 2e 1f 00 00       	call   39ca <exit>
    printf(1, "concreate not enough files in directory listing\n");
    1a9c:	51                   	push   %ecx
    1a9d:	51                   	push   %ecx
    1a9e:	68 38 50 00 00       	push   $0x5038
    1aa3:	6a 01                	push   $0x1
    1aa5:	e8 76 20 00 00       	call   3b20 <printf>
    exit();
    1aaa:	e8 1b 1f 00 00       	call   39ca <exit>
        printf(1, "concreate duplicate file %s\n", de.name);
    1aaf:	83 ec 04             	sub    $0x4,%esp
    1ab2:	8d 45 b2             	lea    -0x4e(%ebp),%eax
    1ab5:	50                   	push   %eax
    1ab6:	68 c9 44 00 00       	push   $0x44c9
    1abb:	6a 01                	push   $0x1
    1abd:	e8 5e 20 00 00       	call   3b20 <printf>
        exit();
    1ac2:	e8 03 1f 00 00       	call   39ca <exit>
...
00001ad0 <linkunlink>:
{
  ...
  printf(1, "linkunlink test\n");
    ...
    1ade:	6a 01                	push   $0x1
    1ae0:	e8 3b 20 00 00       	call   3b20 <printf>
  unlink("x");
    1ae5:	c7 04 24 81 47 00 00 	movl   $0x4781,(%esp)
    1aec:	e8 29 1f 00 00       	call   3a1a <unlink>
  pid = fork();
    1af1:	e8 cc 1e 00 00       	call   39c2 <fork>
  if(pid < 0){
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1b2d:	e8 e8 1e 00 00       	call   3a1a <unlink>
  ...
  for(i = 0; i < 100; i++){
    ...
    1b61:	68 81 47 00 00       	push   $0x4781
    1b66:	e8 9f 1e 00 00       	call   3a0a <open>
    1b6b:	89 04 24             	mov    %eax,(%esp)
    1b6e:	e8 7f 1e 00 00       	call   39f2 <close>
  ...
  if(pid)
    ...
    wait();
    1b82:	e8 4b 1e 00 00       	call   39d2 <wait>
  printf(1, "linkunlink ok\n");
    1b87:	83 ec 08             	sub    $0x8,%esp
    1b8a:	68 09 45 00 00       	push   $0x4509
    1b8f:	6a 01                	push   $0x1
    1b91:	e8 8a 1f 00 00       	call   3b20 <printf>
}
    ...
    1bad:	e8 78 1e 00 00       	call   3a2a <link>
    ...
    1bc1:	6a 01                	push   $0x1
    1bc3:	e8 58 1f 00 00       	call   3b20 <printf>
    exit();
    1bc8:	e8 fd 1d 00 00       	call   39ca <exit>
    exit();
    1bcd:	e8 f8 1d 00 00       	call   39ca <exit>
...
00001be0 <bigdir>:
{
  ...
  printf(1, "bigdir test\n");
    ...
    1bee:	6a 01                	push   $0x1
    1bf0:	e8 2b 1f 00 00       	call   3b20 <printf>
  unlink("bd");
    1bf5:	c7 04 24 25 45 00 00 	movl   $0x4525,(%esp)
    1bfc:	e8 19 1e 00 00       	call   3a1a <unlink>
  fd = open("bd", O_CREATE);
    1c01:	5a                   	pop    %edx
    1c02:	59                   	pop    %ecx
    1c03:	68 00 02 00 00       	push   $0x200
    1c08:	68 25 45 00 00       	push   $0x4525
    1c0d:	e8 f8 1d 00 00       	call   3a0a <open>
  if(fd < 0){
  ...
  close(fd);
    1c25:	50                   	push   %eax
    1c26:	e8 c7 1d 00 00       	call   39f2 <close>
    ...
    if(link("bd", name) != 0){
    1c51:	57                   	push   %edi
    1c52:	68 25 45 00 00       	push   $0x4525
    1c57:	e8 ce 1d 00 00       	call   3a2a <link>
  ...
  unlink("bd");
    ...
    1c78:	e8 9d 1d 00 00       	call   3a1a <unlink>
    ...
    if(unlink(name) != 0){
    1ca1:	57                   	push   %edi
    1ca2:	e8 73 1d 00 00       	call   3a1a <unlink>
  ...
  printf(1, "bigdir ok\n");
    ...
    1cc1:	6a 01                	push   $0x1
    1cc3:	e8 58 1e 00 00       	call   3b20 <printf>
    ...
    1cdb:	6a 01                	push   $0x1
    1cdd:	e8 3e 1e 00 00       	call   3b20 <printf>
      exit();
    1ce2:	e8 e3 1c 00 00       	call   39ca <exit>
      printf(1, "bigdir unlink failed");
    1ce7:	83 ec 08             	sub    $0x8,%esp
    1cea:	68 52 45 00 00       	push   $0x4552
    1cef:	6a 01                	push   $0x1
    1cf1:	e8 2a 1e 00 00       	call   3b20 <printf>
      exit();
    1cf6:	e8 cf 1c 00 00       	call   39ca <exit>
    printf(1, "bigdir create failed\n");
    1cfb:	50                   	push   %eax
    1cfc:	50                   	push   %eax
    1cfd:	68 28 45 00 00       	push   $0x4528
    1d02:	6a 01                	push   $0x1
    1d04:	e8 17 1e 00 00       	call   3b20 <printf>
    exit();
    1d09:	e8 bc 1c 00 00       	call   39ca <exit>
...
00001d10 <subdir>:
{
  ...
  printf(1, "subdir test\n");
    ...
    1d1c:	6a 01                	push   $0x1
    1d1e:	e8 fd 1d 00 00       	call   3b20 <printf>
  unlink("ff");
    1d23:	c7 04 24 fb 45 00 00 	movl   $0x45fb,(%esp)
    1d2a:	e8 eb 1c 00 00       	call   3a1a <unlink>
  if(mkdir("dd") != 0){
    1d2f:	c7 04 24 98 46 00 00 	movl   $0x4698,(%esp)
    1d36:	e8 f7 1c 00 00       	call   3a32 <mkdir>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d53:	e8 b2 1c 00 00       	call   3a0a <open>
  if(fd < 0){
  ...
  write(fd, "ff", 2);
    ...
    1d6f:	50                   	push   %eax
    1d70:	e8 75 1c 00 00       	call   39ea <write>
  close(fd);
    1d75:	89 1c 24             	mov    %ebx,(%esp)
    1d78:	e8 75 1c 00 00       	call   39f2 <close>
  if(unlink("dd") >= 0){
    1d7d:	c7 04 24 98 46 00 00 	movl   $0x4698,(%esp)
    1d84:	e8 91 1c 00 00       	call   3a1a <unlink>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    1d9c:	e8 91 1c 00 00       	call   3a32 <mkdir>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1db9:	e8 4c 1c 00 00       	call   3a0a <open>
  if(fd < 0){
  ...
  write(fd, "FF", 2);
    ...
    1dd5:	50                   	push   %eax
    1dd6:	e8 0f 1c 00 00       	call   39ea <write>
  close(fd);
    1ddb:	89 1c 24             	mov    %ebx,(%esp)
    1dde:	e8 0f 1c 00 00       	call   39f2 <close>
  fd = open("dd/dd/../ff", 0);
    1de3:	58                   	pop    %eax
    1de4:	5a                   	pop    %edx
    1de5:	6a 00                	push   $0x0
    1de7:	68 f2 45 00 00       	push   $0x45f2
    1dec:	e8 19 1c 00 00       	call   3a0a <open>
  if(fd < 0){
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1e0b:	50                   	push   %eax
    1e0c:	e8 d1 1b 00 00       	call   39e2 <read>
  if(cc != 2 || buf[0] != 'f'){
  ...
  close(fd);
    ...
    1e2d:	53                   	push   %ebx
    1e2e:	e8 bf 1b 00 00       	call   39f2 <close>
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1e33:	59                   	pop    %ecx
    1e34:	5b                   	pop    %ebx
    1e35:	68 32 46 00 00       	push   $0x4632
    1e3a:	68 ce 45 00 00       	push   $0x45ce
    1e3f:	e8 e6 1b 00 00       	call   3a2a <link>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1e57:	e8 be 1b 00 00       	call   3a1a <unlink>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1e71:	e8 94 1b 00 00       	call   3a0a <open>
  ...
  if(chdir("dd") != 0){
    ...
    1e89:	e8 ac 1b 00 00       	call   3a3a <chdir>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    1ea1:	e8 94 1b 00 00       	call   3a3a <chdir>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    1eb9:	e8 7c 1b 00 00       	call   3a3a <chdir>
  ...
  if(chdir("./..") != 0){
    ...
    1ed1:	e8 64 1b 00 00       	call   3a3a <chdir>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1eeb:	e8 1a 1b 00 00       	call   3a0a <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    1f0a:	50                   	push   %eax
    1f0b:	e8 d2 1a 00 00       	call   39e2 <read>
  ...
  close(fd);
    ...
    1f1f:	53                   	push   %ebx
    1f20:	e8 cd 1a 00 00       	call   39f2 <close>
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    1f25:	58                   	pop    %eax
    1f26:	5a                   	pop    %edx
    1f27:	6a 00                	push   $0x0
    1f29:	68 ce 45 00 00       	push   $0x45ce
    1f2e:	e8 d7 1a 00 00       	call   3a0a <open>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f4b:	e8 ba 1a 00 00       	call   3a0a <open>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f68:	e8 9d 1a 00 00       	call   3a0a <open>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    1f85:	e8 80 1a 00 00       	call   3a0a <open>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    1f9f:	e8 66 1a 00 00       	call   3a0a <open>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    1fb9:	e8 4c 1a 00 00       	call   3a0a <open>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    1fd6:	e8 4f 1a 00 00       	call   3a2a <link>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    1ff3:	e8 32 1a 00 00       	call   3a2a <link>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    2010:	e8 15 1a 00 00       	call   3a2a <link>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    2028:	e8 05 1a 00 00       	call   3a32 <mkdir>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    2040:	e8 ed 19 00 00       	call   3a32 <mkdir>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2058:	e8 d5 19 00 00       	call   3a32 <mkdir>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    2070:	e8 a5 19 00 00       	call   3a1a <unlink>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    2088:	e8 8d 19 00 00       	call   3a1a <unlink>
  ...
  if(chdir("dd/ff") == 0){
    ...
    20a0:	e8 95 19 00 00       	call   3a3a <chdir>
  ...
  if(chdir("dd/xx") == 0){
    ...
    20b8:	e8 7d 19 00 00       	call   3a3a <chdir>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    20d0:	e8 45 19 00 00       	call   3a1a <unlink>
  ...
  if(unlink("dd/ff") != 0){
    ...
    20e8:	e8 2d 19 00 00       	call   3a1a <unlink>
  ...
  if(unlink("dd") == 0){
    ...
    2100:	e8 15 19 00 00       	call   3a1a <unlink>
  ...
  if(unlink("dd/dd") < 0){
    ...
    2118:	e8 fd 18 00 00       	call   3a1a <unlink>
  ...
  if(unlink("dd") < 0){
    ...
    2130:	e8 e5 18 00 00       	call   3a1a <unlink>
  ...
  printf(1, "subdir ok\n");
    ...
    2148:	6a 01                	push   $0x1
    214a:	e8 d1 19 00 00       	call   3b20 <printf>
}
    ...
    215e:	6a 01                	push   $0x1
    2160:	e8 bb 19 00 00       	call   3b20 <printf>
    exit();
    2165:	e8 60 18 00 00       	call   39ca <exit>
    printf(1, "chdir dd/../../dd failed\n");
    216a:	50                   	push   %eax
    216b:	50                   	push   %eax
    216c:	68 72 46 00 00       	push   $0x4672
    2171:	6a 01                	push   $0x1
    2173:	e8 a8 19 00 00       	call   3b20 <printf>
    exit();
    2178:	e8 4d 18 00 00       	call   39ca <exit>
    printf(1, "unlink dd/dd/ff failed\n");
    217d:	50                   	push   %eax
    217e:	50                   	push   %eax
    217f:	68 3d 46 00 00       	push   $0x463d
    2184:	6a 01                	push   $0x1
    2186:	e8 95 19 00 00       	call   3b20 <printf>
    exit();
    218b:	e8 3a 18 00 00       	call   39ca <exit>
    printf(1, "create dd/ff/ff succeeded!\n");
    2190:	51                   	push   %ecx
    2191:	51                   	push   %ecx
    2192:	68 ef 46 00 00       	push   $0x46ef
    2197:	6a 01                	push   $0x1
    2199:	e8 82 19 00 00       	call   3b20 <printf>
    exit();
    219e:	e8 27 18 00 00       	call   39ca <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded!\n");
    21a3:	53                   	push   %ebx
    21a4:	53                   	push   %ebx
    21a5:	68 dc 50 00 00       	push   $0x50dc
    21aa:	6a 01                	push   $0x1
    21ac:	e8 6f 19 00 00       	call   3b20 <printf>
    exit();
    21b1:	e8 14 18 00 00       	call   39ca <exit>
    printf(1, "mkdir dd/ff/ff succeeded!\n");
    21b6:	51                   	push   %ecx
    21b7:	51                   	push   %ecx
    21b8:	68 83 47 00 00       	push   $0x4783
    21bd:	6a 01                	push   $0x1
    21bf:	e8 5c 19 00 00       	call   3b20 <printf>
    exit();
    21c4:	e8 01 18 00 00       	call   39ca <exit>
    printf(1, "link dd/ff dd/dd/ffff succeeded!\n");
    21c9:	53                   	push   %ebx
    21ca:	53                   	push   %ebx
    21cb:	68 4c 51 00 00       	push   $0x514c
    21d0:	6a 01                	push   $0x1
    21d2:	e8 49 19 00 00       	call   3b20 <printf>
    exit();
    21d7:	e8 ee 17 00 00       	call   39ca <exit>
    printf(1, "open dd/dd/../ff failed\n");
    21dc:	50                   	push   %eax
    21dd:	50                   	push   %eax
    21de:	68 fe 45 00 00       	push   $0x45fe
    21e3:	6a 01                	push   $0x1
    21e5:	e8 36 19 00 00       	call   3b20 <printf>
    exit();
    21ea:	e8 db 17 00 00       	call   39ca <exit>
    printf(1, "create dd/dd/ff failed\n");
    21ef:	51                   	push   %ecx
    21f0:	51                   	push   %ecx
    21f1:	68 d7 45 00 00       	push   $0x45d7
    21f6:	6a 01                	push   $0x1
    21f8:	e8 23 19 00 00       	call   3b20 <printf>
    exit();
    21fd:	e8 c8 17 00 00       	call   39ca <exit>
    printf(1, "chdir ./.. failed\n");
    2202:	50                   	push   %eax
    2203:	50                   	push   %eax
    2204:	68 a0 46 00 00       	push   $0x46a0
    2209:	6a 01                	push   $0x1
    220b:	e8 10 19 00 00       	call   3b20 <printf>
    exit();
    2210:	e8 b5 17 00 00       	call   39ca <exit>
    printf(1, "link dd/dd/ff dd/dd/ffff failed\n");
    2215:	52                   	push   %edx
    2216:	52                   	push   %edx
    2217:	68 94 50 00 00       	push   $0x5094
    221c:	6a 01                	push   $0x1
    221e:	e8 fd 18 00 00       	call   3b20 <printf>
    exit();
    2223:	e8 a2 17 00 00       	call   39ca <exit>
    printf(1, "link dd/xx/ff dd/dd/xx succeeded!\n");
    2228:	50                   	push   %eax
    2229:	50                   	push   %eax
    222a:	68 28 51 00 00       	push   $0x5128
    222f:	6a 01                	push   $0x1
    2231:	e8 ea 18 00 00       	call   3b20 <printf>
    exit();
    2236:	e8 8f 17 00 00       	call   39ca <exit>
    printf(1, "link dd/ff/ff dd/dd/xx succeeded!\n");
    223b:	50                   	push   %eax
    223c:	50                   	push   %eax
    223d:	68 04 51 00 00       	push   $0x5104
    2242:	6a 01                	push   $0x1
    2244:	e8 d7 18 00 00       	call   3b20 <printf>
    exit();
    2249:	e8 7c 17 00 00       	call   39ca <exit>
    printf(1, "open dd wronly succeeded!\n");
    224e:	50                   	push   %eax
    224f:	50                   	push   %eax
    2250:	68 5f 47 00 00       	push   $0x475f
    2255:	6a 01                	push   $0x1
    2257:	e8 c4 18 00 00       	call   3b20 <printf>
    exit();
    225c:	e8 69 17 00 00       	call   39ca <exit>
    printf(1, "open dd rdwr succeeded!\n");
    2261:	50                   	push   %eax
    2262:	50                   	push   %eax
    2263:	68 46 47 00 00       	push   $0x4746
    2268:	6a 01                	push   $0x1
    226a:	e8 b1 18 00 00       	call   3b20 <printf>
    exit();
    226f:	e8 56 17 00 00       	call   39ca <exit>
    printf(1, "create dd succeeded!\n");
    2274:	50                   	push   %eax
    2275:	50                   	push   %eax
    2276:	68 30 47 00 00       	push   $0x4730
    227b:	6a 01                	push   $0x1
    227d:	e8 9e 18 00 00       	call   3b20 <printf>
    exit();
    2282:	e8 43 17 00 00       	call   39ca <exit>
    printf(1, "create dd/xx/ff succeeded!\n");
    2287:	52                   	push   %edx
    2288:	52                   	push   %edx
    2289:	68 14 47 00 00       	push   $0x4714
    228e:	6a 01                	push   $0x1
    2290:	e8 8b 18 00 00       	call   3b20 <printf>
    exit();
    2295:	e8 30 17 00 00       	call   39ca <exit>
    printf(1, "chdir dd failed\n");
    229a:	50                   	push   %eax
    229b:	50                   	push   %eax
    229c:	68 55 46 00 00       	push   $0x4655
    22a1:	6a 01                	push   $0x1
    22a3:	e8 78 18 00 00       	call   3b20 <printf>
    exit();
    22a8:	e8 1d 17 00 00       	call   39ca <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    22ad:	50                   	push   %eax
    22ae:	50                   	push   %eax
    22af:	68 b8 50 00 00       	push   $0x50b8
    22b4:	6a 01                	push   $0x1
    22b6:	e8 65 18 00 00       	call   3b20 <printf>
    exit();
    22bb:	e8 0a 17 00 00       	call   39ca <exit>
    printf(1, "subdir mkdir dd/dd failed\n");
    22c0:	53                   	push   %ebx
    22c1:	53                   	push   %ebx
    22c2:	68 b3 45 00 00       	push   $0x45b3
    22c7:	6a 01                	push   $0x1
    22c9:	e8 52 18 00 00       	call   3b20 <printf>
    exit();
    22ce:	e8 f7 16 00 00       	call   39ca <exit>
    printf(1, "unlink dd (non-empty dir) succeeded!\n");
    22d3:	50                   	push   %eax
    22d4:	50                   	push   %eax
    22d5:	68 6c 50 00 00       	push   $0x506c
    22da:	6a 01                	push   $0x1
    22dc:	e8 3f 18 00 00       	call   3b20 <printf>
    exit();
    22e1:	e8 e4 16 00 00       	call   39ca <exit>
    printf(1, "create dd/ff failed\n");
    22e6:	50                   	push   %eax
    22e7:	50                   	push   %eax
    22e8:	68 97 45 00 00       	push   $0x4597
    22ed:	6a 01                	push   $0x1
    22ef:	e8 2c 18 00 00       	call   3b20 <printf>
    exit();
    22f4:	e8 d1 16 00 00       	call   39ca <exit>
    printf(1, "subdir mkdir dd failed\n");
    22f9:	50                   	push   %eax
    22fa:	50                   	push   %eax
    22fb:	68 7f 45 00 00       	push   $0x457f
    2300:	6a 01                	push   $0x1
    2302:	e8 19 18 00 00       	call   3b20 <printf>
    exit();
    2307:	e8 be 16 00 00       	call   39ca <exit>
    printf(1, "unlink dd failed\n");
    230c:	50                   	push   %eax
    230d:	50                   	push   %eax
    230e:	68 68 48 00 00       	push   $0x4868
    2313:	6a 01                	push   $0x1
    2315:	e8 06 18 00 00       	call   3b20 <printf>
    exit();
    231a:	e8 ab 16 00 00       	call   39ca <exit>
    printf(1, "unlink dd/dd failed\n");
    231f:	52                   	push   %edx
    2320:	52                   	push   %edx
    2321:	68 53 48 00 00       	push   $0x4853
    2326:	6a 01                	push   $0x1
    2328:	e8 f3 17 00 00       	call   3b20 <printf>
    exit();
    232d:	e8 98 16 00 00       	call   39ca <exit>
    printf(1, "unlink non-empty dd succeeded!\n");
    2332:	51                   	push   %ecx
    2333:	51                   	push   %ecx
    2334:	68 70 51 00 00       	push   $0x5170
    2339:	6a 01                	push   $0x1
    233b:	e8 e0 17 00 00       	call   3b20 <printf>
    exit();
    2340:	e8 85 16 00 00       	call   39ca <exit>
    printf(1, "unlink dd/ff failed\n");
    2345:	53                   	push   %ebx
    2346:	53                   	push   %ebx
    2347:	68 3e 48 00 00       	push   $0x483e
    234c:	6a 01                	push   $0x1
    234e:	e8 cd 17 00 00       	call   3b20 <printf>
    exit();
    2353:	e8 72 16 00 00       	call   39ca <exit>
    printf(1, "chdir dd/xx succeeded!\n");
    2358:	50                   	push   %eax
    2359:	50                   	push   %eax
    235a:	68 26 48 00 00       	push   $0x4826
    235f:	6a 01                	push   $0x1
    2361:	e8 ba 17 00 00       	call   3b20 <printf>
    exit();
    2366:	e8 5f 16 00 00       	call   39ca <exit>
    printf(1, "chdir dd/ff succeeded!\n");
    236b:	50                   	push   %eax
    236c:	50                   	push   %eax
    236d:	68 0e 48 00 00       	push   $0x480e
    2372:	6a 01                	push   $0x1
    2374:	e8 a7 17 00 00       	call   3b20 <printf>
    exit();
    2379:	e8 4c 16 00 00       	call   39ca <exit>
    printf(1, "unlink dd/ff/ff succeeded!\n");
    237e:	50                   	push   %eax
    237f:	50                   	push   %eax
    2380:	68 f2 47 00 00       	push   $0x47f2
    2385:	6a 01                	push   $0x1
    2387:	e8 94 17 00 00       	call   3b20 <printf>
    exit();
    238c:	e8 39 16 00 00       	call   39ca <exit>
    printf(1, "unlink dd/xx/ff succeeded!\n");
    2391:	50                   	push   %eax
    2392:	50                   	push   %eax
    2393:	68 d6 47 00 00       	push   $0x47d6
    2398:	6a 01                	push   $0x1
    239a:	e8 81 17 00 00       	call   3b20 <printf>
    exit();
    239f:	e8 26 16 00 00       	call   39ca <exit>
    printf(1, "mkdir dd/dd/ffff succeeded!\n");
    23a4:	50                   	push   %eax
    23a5:	50                   	push   %eax
    23a6:	68 b9 47 00 00       	push   $0x47b9
    23ab:	6a 01                	push   $0x1
    23ad:	e8 6e 17 00 00       	call   3b20 <printf>
    exit();
    23b2:	e8 13 16 00 00       	call   39ca <exit>
    printf(1, "mkdir dd/xx/ff succeeded!\n");
    23b7:	52                   	push   %edx
    23b8:	52                   	push   %edx
    23b9:	68 9e 47 00 00       	push   $0x479e
    23be:	6a 01                	push   $0x1
    23c0:	e8 5b 17 00 00       	call   3b20 <printf>
    exit();
    23c5:	e8 00 16 00 00       	call   39ca <exit>
    printf(1, "read dd/dd/ffff wrong len\n");
    23ca:	51                   	push   %ecx
    23cb:	51                   	push   %ecx
    23cc:	68 cb 46 00 00       	push   $0x46cb
    23d1:	6a 01                	push   $0x1
    23d3:	e8 48 17 00 00       	call   3b20 <printf>
    exit();
    23d8:	e8 ed 15 00 00       	call   39ca <exit>
    printf(1, "open dd/dd/ffff failed\n");
    23dd:	53                   	push   %ebx
    23de:	53                   	push   %ebx
    23df:	68 b3 46 00 00       	push   $0x46b3
    23e4:	6a 01                	push   $0x1
    23e6:	e8 35 17 00 00       	call   3b20 <printf>
    exit();
    23eb:	e8 da 15 00 00       	call   39ca <exit>
...
000023f0 <bigwrite>:
{
  ...
  printf(1, "bigwrite test\n");
    ...
    2402:	6a 01                	push   $0x1
    2404:	e8 17 17 00 00       	call   3b20 <printf>
  unlink("bigwrite");
    2409:	c7 04 24 94 48 00 00 	movl   $0x4894,(%esp)
    2410:	e8 05 16 00 00       	call   3a1a <unlink>
    ...
    242d:	e8 d8 15 00 00       	call   3a0a <open>
    if(fd < 0){
    ...
    2444:	50                   	push   %eax
    2445:	e8 a0 15 00 00       	call   39ea <write>
      if(cc != sz){
    ...
    245a:	56                   	push   %esi
    245b:	e8 8a 15 00 00       	call   39ea <write>
      if(cc != sz){
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    close(fd);
    2470:	56                   	push   %esi
    2471:	e8 7c 15 00 00       	call   39f2 <close>
    unlink("bigwrite");
    2476:	c7 04 24 94 48 00 00 	movl   $0x4894,(%esp)
    247d:	e8 98 15 00 00       	call   3a1a <unlink>
  for(sz = 499; sz < 12*512; sz += 471){
  ...
  printf(1, "bigwrite ok\n");
    ...
    2495:	6a 01                	push   $0x1
    2497:	e8 84 16 00 00       	call   3b20 <printf>
}
    ...
    24ad:	6a 01                	push   $0x1
    24af:	e8 6c 16 00 00       	call   3b20 <printf>
        exit();
    24b4:	e8 11 15 00 00       	call   39ca <exit>
      printf(1, "cannot create bigwrite\n");
    24b9:	83 ec 08             	sub    $0x8,%esp
    24bc:	68 9d 48 00 00       	push   $0x489d
    24c1:	6a 01                	push   $0x1
    24c3:	e8 58 16 00 00       	call   3b20 <printf>
      exit();
    24c8:	e8 fd 14 00 00       	call   39ca <exit>
...
000024d0 <bigfile>:
{
  ...
  for(i = 0; i < 20; i++){
    ...
    2538:	56                   	push   %esi
    2539:	e8 ac 14 00 00       	call   39ea <write>
  ...
  close(fd);
    ...
    2557:	56                   	push   %esi
    2558:	e8 95 14 00 00       	call   39f2 <close>
  fd = open("bigfile", 0);
    255d:	5e                   	pop    %esi
    255e:	5f                   	pop    %edi
    255f:	6a 00                	push   $0x0
    2561:	68 f0 48 00 00       	push   $0x48f0
    2566:	e8 9f 14 00 00       	call   3a0a <open>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    258d:	0f be 05 00 87 00 00 	movsbl 0x8700,%eax
  ...
  for(i = 0; ; i++){
    ...
    25bb:	56                   	push   %esi
    25bc:	e8 21 14 00 00       	call   39e2 <read>
    if(cc < 0){
  ...
  close(fd);
    ...
    25cd:	56                   	push   %esi
    25ce:	e8 1f 14 00 00       	call   39f2 <close>
  if(total != 20*600){
  ...
  unlink("bigfile");
    ...
    25ea:	e8 2b 14 00 00       	call   3a1a <unlink>
  printf(1, "bigfile test ok\n");
    25ef:	58                   	pop    %eax
    25f0:	5a                   	pop    %edx
    25f1:	68 7f 49 00 00       	push   $0x497f
    25f6:	6a 01                	push   $0x1
    25f8:	e8 23 15 00 00       	call   3b20 <printf>
}
    ...
    2610:	6a 01                	push   $0x1
    2612:	e8 09 15 00 00       	call   3b20 <printf>
      exit();
    2617:	e8 ae 13 00 00       	call   39ca <exit>
      printf(1, "short read bigfile\n");
    261c:	83 ec 08             	sub    $0x8,%esp
    261f:	68 38 49 00 00       	push   $0x4938
    2624:	6a 01                	push   $0x1
    2626:	e8 f5 14 00 00       	call   3b20 <printf>
      exit();
    262b:	e8 9a 13 00 00       	call   39ca <exit>
      printf(1, "read bigfile failed\n");
    2630:	83 ec 08             	sub    $0x8,%esp
    2633:	68 23 49 00 00       	push   $0x4923
    2638:	6a 01                	push   $0x1
    263a:	e8 e1 14 00 00       	call   3b20 <printf>
      exit();
    263f:	e8 86 13 00 00       	call   39ca <exit>
      printf(1, "write bigfile failed\n");
    2644:	83 ec 08             	sub    $0x8,%esp
    2647:	68 f8 48 00 00       	push   $0x48f8
    264c:	6a 01                	push   $0x1
    264e:	e8 cd 14 00 00       	call   3b20 <printf>
      exit();
    2653:	e8 72 13 00 00       	call   39ca <exit>
    printf(1, "cannot open bigfile\n");
    2658:	53                   	push   %ebx
    2659:	53                   	push   %ebx
    265a:	68 0e 49 00 00       	push   $0x490e
    265f:	6a 01                	push   $0x1
    2661:	e8 ba 14 00 00       	call   3b20 <printf>
    exit();
    2666:	e8 5f 13 00 00       	call   39ca <exit>
    printf(1, "cannot create bigfile");
    266b:	50                   	push   %eax
    266c:	50                   	push   %eax
    266d:	68 e2 48 00 00       	push   $0x48e2
    2672:	6a 01                	push   $0x1
    2674:	e8 a7 14 00 00       	call   3b20 <printf>
    exit();
    2679:	e8 4c 13 00 00       	call   39ca <exit>
    printf(1, "read bigfile wrong total\n");
    267e:	51                   	push   %ecx
    267f:	51                   	push   %ecx
    2680:	68 65 49 00 00       	push   $0x4965
    2685:	6a 01                	push   $0x1
    2687:	e8 94 14 00 00       	call   3b20 <printf>
    exit();
    268c:	e8 39 13 00 00       	call   39ca <exit>
...
000026a0 <fourteen>:
{
  ...
  printf(1, "fourteen test\n");
    ...
    26ab:	6a 01                	push   $0x1
    26ad:	e8 6e 14 00 00       	call   3b20 <printf>
  if(mkdir("12345678901234") != 0){
    26b2:	c7 04 24 cb 49 00 00 	movl   $0x49cb,(%esp)
    26b9:	e8 74 13 00 00       	call   3a32 <mkdir>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    26d1:	e8 5c 13 00 00       	call   3a32 <mkdir>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26ee:	e8 17 13 00 00       	call   3a0a <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    2701:	50                   	push   %eax
    2702:	e8 eb 12 00 00       	call   39f2 <close>
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    2707:	58                   	pop    %eax
    2708:	5a                   	pop    %edx
    2709:	6a 00                	push   $0x0
    270b:	68 50 52 00 00       	push   $0x5250
    2710:	e8 f5 12 00 00       	call   3a0a <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    271f:	50                   	push   %eax
    2720:	e8 cd 12 00 00       	call   39f2 <close>
  if(mkdir("12345678901234/12345678901234") == 0){
    2725:	c7 04 24 bc 49 00 00 	movl   $0x49bc,(%esp)
    272c:	e8 01 13 00 00       	call   3a32 <mkdir>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2740:	e8 ed 12 00 00       	call   3a32 <mkdir>
  ...
  printf(1, "fourteen ok\n");
    ...
    2754:	6a 01                	push   $0x1
    2756:	e8 c5 13 00 00       	call   3b20 <printf>
}
    ...
    2767:	6a 01                	push   $0x1
    2769:	e8 b2 13 00 00       	call   3b20 <printf>
    exit();
    276e:	e8 57 12 00 00       	call   39ca <exit>
    printf(1, "mkdir 12345678901234/123456789012345 succeeded!\n");
    2773:	50                   	push   %eax
    2774:	50                   	push   %eax
    2775:	68 0c 53 00 00       	push   $0x530c
    277a:	6a 01                	push   $0x1
    277c:	e8 9f 13 00 00       	call   3b20 <printf>
    exit();
    2781:	e8 44 12 00 00       	call   39ca <exit>
    printf(1, "mkdir 12345678901234/12345678901234 succeeded!\n");
    2786:	52                   	push   %edx
    2787:	52                   	push   %edx
    2788:	68 bc 52 00 00       	push   $0x52bc
    278d:	6a 01                	push   $0x1
    278f:	e8 8c 13 00 00       	call   3b20 <printf>
    exit();
    2794:	e8 31 12 00 00       	call   39ca <exit>
    printf(1, "open 12345678901234/12345678901234/12345678901234 failed\n");
    2799:	51                   	push   %ecx
    279a:	51                   	push   %ecx
    279b:	68 80 52 00 00       	push   $0x5280
    27a0:	6a 01                	push   $0x1
    27a2:	e8 79 13 00 00       	call   3b20 <printf>
    exit();
    27a7:	e8 1e 12 00 00       	call   39ca <exit>
    printf(1, "create 123456789012345/123456789012345/123456789012345 failed\n");
    27ac:	51                   	push   %ecx
    27ad:	51                   	push   %ecx
    27ae:	68 10 52 00 00       	push   $0x5210
    27b3:	6a 01                	push   $0x1
    27b5:	e8 66 13 00 00       	call   3b20 <printf>
    exit();
    27ba:	e8 0b 12 00 00       	call   39ca <exit>
    printf(1, "mkdir 12345678901234/123456789012345 failed\n");
    27bf:	50                   	push   %eax
    27c0:	50                   	push   %eax
    27c1:	68 b0 51 00 00       	push   $0x51b0
    27c6:	6a 01                	push   $0x1
    27c8:	e8 53 13 00 00       	call   3b20 <printf>
    exit();
    27cd:	e8 f8 11 00 00       	call   39ca <exit>
...
000027e0 <rmdot>:
{
  ...
  printf(1, "rmdot test\n");
    ...
    27eb:	6a 01                	push   $0x1
    27ed:	e8 2e 13 00 00       	call   3b20 <printf>
  if(mkdir("dots") != 0){
    27f2:	c7 04 24 f3 49 00 00 	movl   $0x49f3,(%esp)
    27f9:	e8 34 12 00 00       	call   3a32 <mkdir>
  ...
  if(chdir("dots") != 0){
    ...
    2811:	e8 24 12 00 00       	call   3a3a <chdir>
  ...
  if(unlink(".") == 0){
    ...
    2829:	e8 ec 11 00 00       	call   3a1a <unlink>
  ...
  if(unlink("..") == 0){
    ...
    2841:	e8 d4 11 00 00       	call   3a1a <unlink>
  ...
  if(chdir("/") != 0){
    ...
    2859:	e8 dc 11 00 00       	call   3a3a <chdir>
  ...
  if(unlink("dots/.") == 0){
    ...
    2871:	e8 a4 11 00 00       	call   3a1a <unlink>
  ...
  if(unlink("dots/..") == 0){
    ...
    2885:	e8 90 11 00 00       	call   3a1a <unlink>
  ...
  if(unlink("dots") != 0){
    ...
    2899:	e8 7c 11 00 00       	call   3a1a <unlink>
  ...
  printf(1, "rmdot ok\n");
    ...
    28ad:	6a 01                	push   $0x1
    28af:	e8 6c 12 00 00       	call   3b20 <printf>
}
    ...
    28c0:	6a 01                	push   $0x1
    28c2:	e8 59 12 00 00       	call   3b20 <printf>
    exit();
    28c7:	e8 fe 10 00 00       	call   39ca <exit>
    printf(1, "unlink dots failed!\n");
    28cc:	50                   	push   %eax
    28cd:	50                   	push   %eax
    28ce:	68 79 4a 00 00       	push   $0x4a79
    28d3:	6a 01                	push   $0x1
    28d5:	e8 46 12 00 00       	call   3b20 <printf>
    exit();
    28da:	e8 eb 10 00 00       	call   39ca <exit>
    printf(1, "unlink dots/.. worked!\n");
    28df:	52                   	push   %edx
    28e0:	52                   	push   %edx
    28e1:	68 61 4a 00 00       	push   $0x4a61
    28e6:	6a 01                	push   $0x1
    28e8:	e8 33 12 00 00       	call   3b20 <printf>
    exit();
    28ed:	e8 d8 10 00 00       	call   39ca <exit>
    printf(1, "unlink dots/. worked!\n");
    28f2:	51                   	push   %ecx
    28f3:	51                   	push   %ecx
    28f4:	68 42 4a 00 00       	push   $0x4a42
    28f9:	6a 01                	push   $0x1
    28fb:	e8 20 12 00 00       	call   3b20 <printf>
    exit();
    2900:	e8 c5 10 00 00       	call   39ca <exit>
    printf(1, "chdir / failed\n");
    2905:	50                   	push   %eax
    2906:	50                   	push   %eax
    2907:	68 73 3e 00 00       	push   $0x3e73
    290c:	6a 01                	push   $0x1
    290e:	e8 0d 12 00 00       	call   3b20 <printf>
    exit();
    2913:	e8 b2 10 00 00       	call   39ca <exit>
    printf(1, "rm .. worked!\n");
    2918:	50                   	push   %eax
    2919:	50                   	push   %eax
    291a:	68 2c 4a 00 00       	push   $0x4a2c
    291f:	6a 01                	push   $0x1
    2921:	e8 fa 11 00 00       	call   3b20 <printf>
    exit();
    2926:	e8 9f 10 00 00       	call   39ca <exit>
    printf(1, "rm . worked!\n");
    292b:	50                   	push   %eax
    292c:	50                   	push   %eax
    292d:	68 1e 4a 00 00       	push   $0x4a1e
    2932:	6a 01                	push   $0x1
    2934:	e8 e7 11 00 00       	call   3b20 <printf>
    exit();
    2939:	e8 8c 10 00 00       	call   39ca <exit>
    printf(1, "chdir dots failed\n");
    293e:	50                   	push   %eax
    293f:	50                   	push   %eax
    2940:	68 0b 4a 00 00       	push   $0x4a0b
    2945:	6a 01                	push   $0x1
    2947:	e8 d4 11 00 00       	call   3b20 <printf>
    exit();
    294c:	e8 79 10 00 00       	call   39ca <exit>
...
00002960 <dirfile>:
{
  ...
  printf(1, "dir vs file\n");
    ...
    296c:	6a 01                	push   $0x1
    296e:	e8 ad 11 00 00       	call   3b20 <printf>
  fd = open("dirfile", O_CREATE);
    2973:	5b                   	pop    %ebx
    2974:	58                   	pop    %eax
    2975:	68 00 02 00 00       	push   $0x200
    297a:	68 a5 4a 00 00       	push   $0x4aa5
    297f:	e8 86 10 00 00       	call   3a0a <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    2992:	50                   	push   %eax
    2993:	e8 5a 10 00 00       	call   39f2 <close>
  if(chdir("dirfile") == 0){
    2998:	c7 04 24 a5 4a 00 00 	movl   $0x4aa5,(%esp)
    299f:	e8 96 10 00 00       	call   3a3a <chdir>
  ...
  fd = open("dirfile/xx", 0);
    ...
    29b9:	e8 4c 10 00 00       	call   3a0a <open>
  if(fd >= 0){
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    29d6:	e8 2f 10 00 00       	call   3a0a <open>
  if(fd >= 0){
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    29ee:	e8 3f 10 00 00       	call   3a32 <mkdir>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2a06:	e8 0f 10 00 00       	call   3a1a <unlink>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2a23:	e8 02 10 00 00       	call   3a2a <link>
  ...
  if(unlink("dirfile") != 0){
    ...
    2a3b:	e8 da 0f 00 00       	call   3a1a <unlink>
  ...
  fd = open(".", O_RDWR);
    ...
    2a55:	e8 b0 0f 00 00       	call   3a0a <open>
  if(fd >= 0){
  ...
  fd = open(".", 0);
    ...
    2a6f:	e8 96 0f 00 00       	call   3a0a <open>
  if(write(fd, "x", 1) > 0){
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2a80:	50                   	push   %eax
    2a81:	e8 64 0f 00 00       	call   39ea <write>
  ...
  close(fd);
    ...
    2a90:	53                   	push   %ebx
    2a91:	e8 5c 0f 00 00       	call   39f2 <close>
  printf(1, "dir vs file OK\n");
    2a96:	58                   	pop    %eax
    2a97:	5a                   	pop    %edx
    2a98:	68 75 4b 00 00       	push   $0x4b75
    2a9d:	6a 01                	push   $0x1
    2a9f:	e8 7c 10 00 00       	call   3b20 <printf>
}
    ...
    2ab3:	6a 01                	push   $0x1
    2ab5:	e8 66 10 00 00       	call   3b20 <printf>
    exit();
    2aba:	e8 0b 0f 00 00       	call   39ca <exit>
    printf(1, "chdir dirfile succeeded!\n");
    2abf:	52                   	push   %edx
    2ac0:	52                   	push   %edx
    2ac1:	68 c4 4a 00 00       	push   $0x4ac4
    2ac6:	6a 01                	push   $0x1
    2ac8:	e8 53 10 00 00       	call   3b20 <printf>
    exit();
    2acd:	e8 f8 0e 00 00       	call   39ca <exit>
    printf(1, "create dirfile failed\n");
    2ad2:	51                   	push   %ecx
    2ad3:	51                   	push   %ecx
    2ad4:	68 ad 4a 00 00       	push   $0x4aad
    2ad9:	6a 01                	push   $0x1
    2adb:	e8 40 10 00 00       	call   3b20 <printf>
    exit();
    2ae0:	e8 e5 0e 00 00       	call   39ca <exit>
    printf(1, "write . succeeded!\n");
    2ae5:	51                   	push   %ecx
    2ae6:	51                   	push   %ecx
    2ae7:	68 61 4b 00 00       	push   $0x4b61
    2aec:	6a 01                	push   $0x1
    2aee:	e8 2d 10 00 00       	call   3b20 <printf>
    exit();
    2af3:	e8 d2 0e 00 00       	call   39ca <exit>
    printf(1, "open . for writing succeeded!\n");
    2af8:	53                   	push   %ebx
    2af9:	53                   	push   %ebx
    2afa:	68 60 53 00 00       	push   $0x5360
    2aff:	6a 01                	push   $0x1
    2b01:	e8 1a 10 00 00       	call   3b20 <printf>
    exit();
    2b06:	e8 bf 0e 00 00       	call   39ca <exit>
    printf(1, "unlink dirfile failed!\n");
    2b0b:	50                   	push   %eax
    2b0c:	50                   	push   %eax
    2b0d:	68 49 4b 00 00       	push   $0x4b49
    2b12:	6a 01                	push   $0x1
    2b14:	e8 07 10 00 00       	call   3b20 <printf>
    exit();
    2b19:	e8 ac 0e 00 00       	call   39ca <exit>
    printf(1, "link to dirfile/xx succeeded!\n");
    2b1e:	50                   	push   %eax
    2b1f:	50                   	push   %eax
    2b20:	68 40 53 00 00       	push   $0x5340
    2b25:	6a 01                	push   $0x1
    2b27:	e8 f4 0f 00 00       	call   3b20 <printf>
    exit();
    2b2c:	e8 99 0e 00 00       	call   39ca <exit>
    printf(1, "unlink dirfile/xx succeeded!\n");
    2b31:	50                   	push   %eax
    2b32:	50                   	push   %eax
    2b33:	68 24 4b 00 00       	push   $0x4b24
    2b38:	6a 01                	push   $0x1
    2b3a:	e8 e1 0f 00 00       	call   3b20 <printf>
    exit();
    2b3f:	e8 86 0e 00 00       	call   39ca <exit>
    printf(1, "mkdir dirfile/xx succeeded!\n");
    2b44:	50                   	push   %eax
    2b45:	50                   	push   %eax
    2b46:	68 07 4b 00 00       	push   $0x4b07
    2b4b:	6a 01                	push   $0x1
    2b4d:	e8 ce 0f 00 00       	call   3b20 <printf>
    exit();
    2b52:	e8 73 0e 00 00       	call   39ca <exit>
    ...
    2b64:	bb 33 00 00 00       	mov    $0x33,%ebx
{
  ...
  printf(1, "empty file name\n");
    ...
    2b71:	6a 01                	push   $0x1
    2b73:	e8 a8 0f 00 00       	call   3b20 <printf>
    ...
    2b88:	e8 a5 0e 00 00       	call   3a32 <mkdir>
    ...
    2ba0:	e8 95 0e 00 00       	call   3a3a <chdir>
  ...
  chdir("/");
    ...
    2c38:	e8 fd 0d 00 00       	call   3a3a <chdir>
  printf(1, "empty file name OK\n");
    2c3d:	58                   	pop    %eax
    2c3e:	5a                   	pop    %edx
    2c3f:	68 c4 4b 00 00       	push   $0x4bc4
    2c44:	6a 01                	push   $0x1
    2c46:	e8 d5 0e 00 00       	call   3b20 <printf>
}
    ...
    2c5b:	6a 01                	push   $0x1
    2c5d:	e8 be 0e 00 00       	call   3b20 <printf>
      exit();
    2c62:	e8 63 0d 00 00       	call   39ca <exit>
      printf(1, "chdir irefd failed\n");
    2c67:	83 ec 08             	sub    $0x8,%esp
    2c6a:	68 b0 4b 00 00       	push   $0x4bb0
    2c6f:	6a 01                	push   $0x1
    2c71:	e8 aa 0e 00 00       	call   3b20 <printf>
      exit();
    2c76:	e8 4f 0d 00 00       	call   39ca <exit>
    ...
    2c84:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fork test\n");
    ...
    2c8e:	6a 01                	push   $0x1
    2c90:	e8 8b 0e 00 00       	call   3b20 <printf>
  ...
  for(n=0; n<1000; n++){
    ...
    pid = fork();
    2cad:	e8 10 0d 00 00       	call   39c2 <fork>
    if(pid < 0)
  ...
  for(; n > 0; n--){
    ...
    if(wait() < 0){
    2cc0:	e8 0d 0d 00 00       	call   39d2 <wait>
  ...
  if(wait() != -1){
    2cce:	e8 ff 0c 00 00       	call   39d2 <wait>
  ...
  printf(1, "fork test OK\n");
    ...
    2ce0:	6a 01                	push   $0x1
    2ce2:	e8 39 0e 00 00       	call   3b20 <printf>
}
    2ce7:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    2cea:	c9                   	leave
    2ceb:	c3                   	ret
      exit();
    2cec:	e8 d9 0c 00 00       	call   39ca <exit>
      printf(1, "wait stopped early\n");
    2cf1:	83 ec 08             	sub    $0x8,%esp
    2cf4:	68 e3 4b 00 00       	push   $0x4be3
    2cf9:	6a 01                	push   $0x1
    2cfb:	e8 20 0e 00 00       	call   3b20 <printf>
      exit();
    2d00:	e8 c5 0c 00 00       	call   39ca <exit>
    printf(1, "wait got too many\n");
    2d05:	52                   	push   %edx
    2d06:	52                   	push   %edx
    2d07:	68 f7 4b 00 00       	push   $0x4bf7
    2d0c:	6a 01                	push   $0x1
    2d0e:	e8 0d 0e 00 00       	call   3b20 <printf>
    exit();
    2d13:	e8 b2 0c 00 00       	call   39ca <exit>
    printf(1, "fork claimed to work 1000 times!\n");
    2d18:	50                   	push   %eax
    2d19:	50                   	push   %eax
    2d1a:	68 80 53 00 00       	push   $0x5380
    2d1f:	6a 01                	push   $0x1
    2d21:	e8 fa 0d 00 00       	call   3b20 <printf>
    exit();
    2d26:	e8 9f 0c 00 00       	call   39ca <exit>
    ...
    2d35:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "sbrk test\n");
    ...
    2d40:	ff 35 b8 5f 00 00    	push   0x5fb8
    2d46:	e8 d5 0d 00 00       	call   3b20 <printf>
  oldbrk = sbrk(0);
    2d4b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    2d52:	e8 fb 0c 00 00       	call   3a52 <sbrk>
    2d57:	89 45 a4             	mov    %eax,-0x5c(%ebp)
  a = sbrk(0);
    2d5a:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    2d61:	e8 ec 0c 00 00       	call   3a52 <sbrk>
  ...
  for(i = 0; i < 5000; i++){
    ...
    2d75:	6a 01                	push   $0x1
    2d77:	e8 d6 0c 00 00       	call   3a52 <sbrk>
    if(b != a){
  ...
  pid = fork();
    2d98:	e8 25 0c 00 00       	call   39c2 <fork>
  ...
  c = sbrk(1);
    2dad:	6a 01                	push   $0x1
    2daf:	e8 9e 0c 00 00       	call   3a52 <sbrk>
  c = sbrk(1);
    2db4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2dbb:	e8 92 0c 00 00       	call   3a52 <sbrk>
  if(c != a + 1){
  ...
  wait();
    2dd3:	e8 fa 0b 00 00       	call   39d2 <wait>
  a = sbrk(0);
    2dd8:	83 ec 0c             	sub    $0xc,%esp
    2ddb:	6a 00                	push   $0x0
    2ddd:	e8 70 0c 00 00       	call   3a52 <sbrk>
  ...
  p = sbrk(amt);
    ...
    2dee:	e8 5f 0c 00 00       	call   3a52 <sbrk>
  if (p != a) {
  ...
  *lastaddr = 99;
  ...
  a = sbrk(0);
    2e08:	6a 00                	push   $0x0
    2e0a:	e8 43 0c 00 00       	call   3a52 <sbrk>
  c = sbrk(-4096);
    2e0f:	c7 04 24 00 f0 ff ff 	movl   $0xfffff000,(%esp)
  a = sbrk(0);
    2e16:	89 c3                	mov    %eax,%ebx
  c = sbrk(-4096);
    2e18:	e8 35 0c 00 00       	call   3a52 <sbrk>
  ...
  c = sbrk(0);
    ...
    2e2c:	6a 00                	push   $0x0
    2e2e:	e8 1f 0c 00 00       	call   3a52 <sbrk>
  if(c != a - 4096){
  ...
  a = sbrk(0);
    ...
    2e47:	6a 00                	push   $0x0
    2e49:	e8 04 0c 00 00       	call   3a52 <sbrk>
  c = sbrk(4096);
    2e4e:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
  a = sbrk(0);
    2e55:	89 c3                	mov    %eax,%ebx
  c = sbrk(4096);
    2e57:	e8 f6 0b 00 00       	call   3a52 <sbrk>
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    2e6c:	6a 00                	push   $0x0
    2e6e:	e8 df 0b 00 00       	call   3a52 <sbrk>
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2ecf:	00 
    ppid = getpid();
    2ed0:	e8 75 0b 00 00       	call   3a4a <getpid>
    2ed5:	89 c6                	mov    %eax,%esi
    pid = fork();
    2ed7:	e8 e6 0a 00 00       	call   39c2 <fork>
    if(pid < 0){
    ...
    wait();
    2eea:	e8 e3 0a 00 00       	call   39d2 <wait>
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
  ...
  if(pipe(fds) != 0){
    ...
    2f03:	50                   	push   %eax
    2f04:	e8 d1 0a 00 00       	call   39da <pipe>
    ...
    if((pids[i] = fork()) == 0){
    2f20:	e8 9d 0a 00 00       	call   39c2 <fork>
    ...
    2f40:	e8 9d 0a 00 00       	call   39e2 <read>
  ...
  c = sbrk(4096);
    ...
    2f57:	e8 f6 0a 00 00       	call   3a52 <sbrk>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    2f72:	50                   	push   %eax
    2f73:	e8 82 0a 00 00       	call   39fa <kill>
    wait();
    2f78:	e8 55 0a 00 00       	call   39d2 <wait>
  ...
  if(sbrk(0) > oldbrk)
    ...
    2f93:	6a 00                	push   $0x0
    2f95:	e8 b8 0a 00 00       	call   3a52 <sbrk>
    2f9a:	83 c4 10             	add    $0x10,%esp
    2f9d:	39 45 a4             	cmp    %eax,-0x5c(%ebp)
    2fa0:	72 60                	jb     3002 <sbrktest+0x2d2>
  printf(stdout, "sbrk test OK\n");
    2fa2:	83 ec 08             	sub    $0x8,%esp
    2fa5:	68 c0 4c 00 00       	push   $0x4cc0
    2faa:	ff 35 b8 5f 00 00    	push   0x5fb8
    2fb0:	e8 6b 0b 00 00       	call   3b20 <printf>
}
    ...
    3027:	53                   	push   %ebx
    3028:	56                   	push   %esi
    3029:	68 23 4c 00 00       	push   $0x4c23
    302e:	ff 35 b8 5f 00 00    	push   0x5fb8
    3034:	e8 e7 0a 00 00       	call   3b20 <printf>
      exit();
    3039:	83 c4 20             	add    $0x20,%esp
    303c:	e8 89 09 00 00       	call   39ca <exit>
      printf(stdout, "fork failed\n");
    3041:	83 ec 08             	sub    $0x8,%esp
    3044:	68 69 4d 00 00       	push   $0x4d69
    3049:	ff 35 b8 5f 00 00    	push   0x5fb8
    304f:	e8 cc 0a 00 00       	call   3b20 <printf>
      exit();
    3054:	e8 71 09 00 00       	call   39ca <exit>
      printf(stdout, "oops could read %x = %x\n", a, *a);
    3059:	0f be 03             	movsbl (%ebx),%eax
    305c:	50                   	push   %eax
    305d:	53                   	push   %ebx
    305e:	68 8c 4c 00 00       	push   $0x4c8c
    3063:	ff 35 b8 5f 00 00    	push   0x5fb8
    3069:	e8 b2 0a 00 00       	call   3b20 <printf>
      kill(ppid);
    306e:	89 34 24             	mov    %esi,(%esp)
    3071:	e8 84 09 00 00       	call   39fa <kill>
      exit();
    3076:	e8 4f 09 00 00       	call   39ca <exit>
    printf(stdout, "sbrk downsize failed, a %x c %x\n", a, c);
    307b:	50                   	push   %eax
    307c:	53                   	push   %ebx
    307d:	68 74 54 00 00       	push   $0x5474
    3082:	ff 35 b8 5f 00 00    	push   0x5fb8
    3088:	e8 93 0a 00 00       	call   3b20 <printf>
    exit();
    308d:	e8 38 09 00 00       	call   39ca <exit>
    printf(stdout, "sbrk test failed to grow big address space; enough phys mem?\n");
    3092:	56                   	push   %esi
    3093:	56                   	push   %esi
    3094:	68 a4 53 00 00       	push   $0x53a4
    3099:	ff 35 b8 5f 00 00    	push   0x5fb8
    309f:	e8 7c 0a 00 00       	call   3b20 <printf>
    exit();
    30a4:	e8 21 09 00 00       	call   39ca <exit>
    printf(stdout, "sbrk test fork failed\n");
    30a9:	50                   	push   %eax
    30aa:	50                   	push   %eax
    30ab:	68 3e 4c 00 00       	push   $0x4c3e
    30b0:	ff 35 b8 5f 00 00    	push   0x5fb8
    30b6:	e8 65 0a 00 00       	call   3b20 <printf>
    exit();
    30bb:	e8 0a 09 00 00       	call   39ca <exit>
    printf(stdout, "sbrk de-allocation didn't really deallocate\n");
    30c0:	51                   	push   %ecx
    30c1:	51                   	push   %ecx
    30c2:	68 44 54 00 00       	push   $0x5444
    30c7:	ff 35 b8 5f 00 00    	push   0x5fb8
    30cd:	e8 4e 0a 00 00       	call   3b20 <printf>
    exit();
    30d2:	e8 f3 08 00 00       	call   39ca <exit>
    printf(stdout, "failed sbrk leaked memory\n");
    30d7:	50                   	push   %eax
    30d8:	50                   	push   %eax
    30d9:	68 a5 4c 00 00       	push   $0x4ca5
    30de:	ff 35 b8 5f 00 00    	push   0x5fb8
    30e4:	e8 37 0a 00 00       	call   3b20 <printf>
    exit();
    30e9:	e8 dc 08 00 00       	call   39ca <exit>
    printf(1, "pipe() failed\n");
    30ee:	52                   	push   %edx
    30ef:	52                   	push   %edx
    30f0:	68 61 41 00 00       	push   $0x4161
    30f5:	6a 01                	push   $0x1
    30f7:	e8 24 0a 00 00       	call   3b20 <printf>
    exit();
    30fc:	e8 c9 08 00 00       	call   39ca <exit>
    exit();
    3101:	e8 c4 08 00 00       	call   39ca <exit>
    printf(stdout, "sbrk test failed post-fork\n");
    3106:	57                   	push   %edi
    3107:	57                   	push   %edi
    3108:	68 55 4c 00 00       	push   $0x4c55
    310d:	ff 35 b8 5f 00 00    	push   0x5fb8
    3113:	e8 08 0a 00 00       	call   3b20 <printf>
    exit();
    3118:	e8 ad 08 00 00       	call   39ca <exit>
    printf(stdout, "sbrk re-allocation failed, a %x c %x\n", a, c);
    311d:	56                   	push   %esi
    311e:	53                   	push   %ebx
    311f:	68 1c 54 00 00       	push   $0x541c
    3124:	ff 35 b8 5f 00 00    	push   0x5fb8
    312a:	e8 f1 09 00 00       	call   3b20 <printf>
    exit();
    312f:	e8 96 08 00 00       	call   39ca <exit>
    printf(stdout, "sbrk deallocation produced wrong address, a %x c %x\n", a, c);
    3134:	50                   	push   %eax
    3135:	53                   	push   %ebx
    3136:	68 e4 53 00 00       	push   $0x53e4
    313b:	ff 35 b8 5f 00 00    	push   0x5fb8
    3141:	e8 da 09 00 00       	call   3b20 <printf>
    exit();
    3146:	e8 7f 08 00 00       	call   39ca <exit>
    printf(stdout, "sbrk could not deallocate\n");
    314b:	53                   	push   %ebx
    314c:	53                   	push   %ebx
    314d:	68 71 4c 00 00       	push   $0x4c71
    3152:	ff 35 b8 5f 00 00    	push   0x5fb8
    3158:	e8 c3 09 00 00       	call   3b20 <printf>
    exit();
    315d:	e8 68 08 00 00       	call   39ca <exit>
    ...
    3184:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "validate test\n");
    ...
    318f:	ff 35 b8 5f 00 00    	push   0x5fb8
    3195:	e8 86 09 00 00       	call   3b20 <printf>
    319a:	83 c4 10             	add    $0x10,%esp
    319d:	8d 76 00             	lea    0x0(%esi),%esi
    if((pid = fork()) == 0){
    31a0:	e8 1d 08 00 00       	call   39c2 <fork>
    ...
    31ae:	6a 00                	push   $0x0
    31b0:	e8 a5 08 00 00       	call   3a5a <sleep>
    sleep(0);
    31b5:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    31bc:	e8 99 08 00 00       	call   3a5a <sleep>
    kill(pid);
    31c1:	89 1c 24             	mov    %ebx,(%esp)
    31c4:	e8 31 08 00 00       	call   39fa <kill>
    wait();
    31c9:	e8 04 08 00 00       	call   39d2 <wait>
    if(link("nosuchfile", (char*)p) != -1){
    31ce:	58                   	pop    %eax
    31cf:	5a                   	pop    %edx
    31d0:	56                   	push   %esi
    31d1:	68 dd 4c 00 00       	push   $0x4cdd
    31d6:	e8 4f 08 00 00       	call   3a2a <link>
  ...
  printf(stdout, "validate ok\n");
    ...
    31f9:	ff 35 b8 5f 00 00    	push   0x5fb8
    31ff:	e8 1c 09 00 00       	call   3b20 <printf>
}
    ...
    320d:	c3                   	ret
      exit();
    320e:	e8 b7 07 00 00       	call   39ca <exit>
      printf(stdout, "link should not succeed\n");
    3213:	83 ec 08             	sub    $0x8,%esp
    3216:	68 e8 4c 00 00       	push   $0x4ce8
    321b:	ff 35 b8 5f 00 00    	push   0x5fb8
    3221:	e8 fa 08 00 00       	call   3b20 <printf>
      exit();
    3226:	e8 9f 07 00 00       	call   39ca <exit>
...
00003230 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    ...
    323b:	ff 35 b8 5f 00 00    	push   0x5fb8
    3241:	e8 da 08 00 00       	call   3b20 <printf>
  ...
  printf(stdout, "bss test ok\n");
    ...
    3266:	68 29 4d 00 00       	push   $0x4d29
    326b:	ff 35 b8 5f 00 00    	push   0x5fb8
    3271:	e8 aa 08 00 00       	call   3b20 <printf>
}
    ...
    327e:	68 18 4d 00 00       	push   $0x4d18
    3283:	ff 35 b8 5f 00 00    	push   0x5fb8
    3289:	e8 92 08 00 00       	call   3b20 <printf>
      exit();
    328e:	e8 37 07 00 00       	call   39ca <exit>
...
000032a0 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    32a6:	68 36 4d 00 00       	push   $0x4d36
    32ab:	e8 6a 07 00 00       	call   3a1a <unlink>
  pid = fork();
    32b0:	e8 0d 07 00 00       	call   39c2 <fork>
  if(pid == 0){
  ...
  wait();
    32c2:	e8 0b 07 00 00       	call   39d2 <wait>
  fd = open("bigarg-ok", 0);
    32c7:	83 ec 08             	sub    $0x8,%esp
    32ca:	6a 00                	push   $0x0
    32cc:	68 36 4d 00 00       	push   $0x4d36
    32d1:	e8 34 07 00 00       	call   3a0a <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    32e4:	50                   	push   %eax
    32e5:	e8 08 07 00 00       	call   39f2 <close>
  unlink("bigarg-ok");
    32ea:	c7 04 24 36 4d 00 00 	movl   $0x4d36,(%esp)
    32f1:	e8 24 07 00 00       	call   3a1a <unlink>
}
    32f6:	83 c4 10             	add    $0x10,%esp
    32f9:	c9                   	leave
    32fa:	c3                   	ret
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    32fb:	c7 04 85 00 a7 00 00 	movl   $0x5498,0xa700(,%eax,4)
    3302:	98 54 00 00 
    for(i = 0; i < MAXARG-1; i++)
    3306:	b8 01 00 00 00       	mov    $0x1,%eax
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    330b:	c7 04 85 00 a7 00 00 	movl   $0x5498,0xa700(,%eax,4)
    3312:	98 54 00 00 
    3316:	c7 04 85 04 a7 00 00 	movl   $0x5498,0xa704(,%eax,4)
    331d:	98 54 00 00 
    for(i = 0; i < MAXARG-1; i++)
    ...
    printf(stdout, "bigarg test\n");
    332c:	50                   	push   %eax
    332d:	68 40 4d 00 00       	push   $0x4d40
    3332:	ff 35 b8 5f 00 00    	push   0x5fb8
    args[MAXARG-1] = 0;
    3338:	89 0d 7c a7 00 00    	mov    %ecx,0xa77c
    printf(stdout, "bigarg test\n");
    333e:	e8 dd 07 00 00       	call   3b20 <printf>
    exec("echo", args);
    3343:	58                   	pop    %eax
    3344:	5a                   	pop    %edx
    3345:	68 00 a7 00 00       	push   $0xa700
    334a:	68 0d 3f 00 00       	push   $0x3f0d
    334f:	e8 ae 06 00 00       	call   3a02 <exec>
    printf(stdout, "bigarg test ok\n");
    3354:	59                   	pop    %ecx
    3355:	58                   	pop    %eax
    3356:	68 4d 4d 00 00       	push   $0x4d4d
    335b:	ff 35 b8 5f 00 00    	push   0x5fb8
    3361:	e8 ba 07 00 00       	call   3b20 <printf>
    fd = open("bigarg-ok", O_CREATE);
    3366:	58                   	pop    %eax
    3367:	5a                   	pop    %edx
    3368:	68 00 02 00 00       	push   $0x200
    336d:	68 36 4d 00 00       	push   $0x4d36
    3372:	e8 93 06 00 00       	call   3a0a <open>
    close(fd);
    3377:	89 04 24             	mov    %eax,(%esp)
    337a:	e8 73 06 00 00       	call   39f2 <close>
    exit();
    337f:	e8 46 06 00 00       	call   39ca <exit>
    printf(stdout, "bigarg test failed!\n");
    3384:	50                   	push   %eax
    3385:	50                   	push   %eax
    3386:	68 76 4d 00 00       	push   $0x4d76
    338b:	ff 35 b8 5f 00 00    	push   0x5fb8
    3391:	e8 8a 07 00 00       	call   3b20 <printf>
    exit();
    3396:	e8 2f 06 00 00       	call   39ca <exit>
    printf(stdout, "bigargtest: fork failed\n");
    339b:	52                   	push   %edx
    339c:	52                   	push   %edx
    339d:	68 5d 4d 00 00       	push   $0x4d5d
    33a2:	ff 35 b8 5f 00 00    	push   0x5fb8
    33a8:	e8 73 07 00 00       	call   3b20 <printf>
    exit();
    33ad:	e8 18 06 00 00       	call   39ca <exit>
    ...
    33c5:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "fsfull test\n");
    33cb:	68 8b 4d 00 00       	push   $0x4d8b
    33d0:	6a 01                	push   $0x1
    33d2:	e8 49 07 00 00       	call   3b20 <printf>
    ...
    3451:	50                   	push   %eax
    3452:	68 98 4d 00 00       	push   $0x4d98
    3457:	6a 01                	push   $0x1
    3459:	e8 c2 06 00 00       	call   3b20 <printf>
    ...
    3468:	50                   	push   %eax
    3469:	e8 9c 05 00 00       	call   3a0a <open>
    if(fd < 0){
    ...
    348a:	68 00 87 00 00       	push   $0x8700
    348f:	57                   	push   %edi
    3490:	e8 55 05 00 00       	call   39ea <write>
      if(cc < 512)
    ...
    34a2:	53                   	push   %ebx
    34a3:	68 b4 4d 00 00       	push   $0x4db4
    34a8:	6a 01                	push   $0x1
    34aa:	e8 71 06 00 00       	call   3b20 <printf>
    close(fd);
    34af:	89 3c 24             	mov    %edi,(%esp)
    34b2:	e8 3b 05 00 00       	call   39f2 <close>
    if(total == 0)
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    34cc:	50                   	push   %eax
    34cd:	68 a4 4d 00 00       	push   $0x4da4
    34d2:	6a 01                	push   $0x1
    34d4:	e8 47 06 00 00       	call   3b20 <printf>
      break;
    ...
    355b:	50                   	push   %eax
    355c:	e8 b9 04 00 00       	call   3a1a <unlink>
  while(nfiles >= 0){
  ...
  printf(1, "fsfull test finished\n");
    ...
    356c:	68 c4 4d 00 00       	push   $0x4dc4
    3571:	6a 01                	push   $0x1
    3573:	e8 a8 05 00 00       	call   3b20 <printf>
}
...
00003590 <uio>:
{
  ...
  printf(1, "uio test\n");
    3596:	68 da 4d 00 00       	push   $0x4dda
    359b:	6a 01                	push   $0x1
    359d:	e8 7e 05 00 00       	call   3b20 <printf>
  pid = fork();
    35a2:	e8 1b 04 00 00       	call   39c2 <fork>
  if(pid == 0){
  ...
  wait();
    35b0:	e8 1d 04 00 00       	call   39d2 <wait>
  printf(1, "uio test done\n");
    35b5:	83 ec 08             	sub    $0x8,%esp
    35b8:	68 e4 4d 00 00       	push   $0x4de4
    35bd:	6a 01                	push   $0x1
    35bf:	e8 5c 05 00 00       	call   3b20 <printf>
}
    ...
    35da:	52                   	push   %edx
    35db:	52                   	push   %edx
    35dc:	68 78 55 00 00       	push   $0x5578
    35e1:	6a 01                	push   $0x1
    35e3:	e8 38 05 00 00       	call   3b20 <printf>
    exit();
    35e8:	e8 dd 03 00 00       	call   39ca <exit>
    printf (1, "fork failed\n");
    35ed:	50                   	push   %eax
    35ee:	50                   	push   %eax
    35ef:	68 69 4d 00 00       	push   $0x4d69
    35f4:	6a 01                	push   $0x1
    35f6:	e8 25 05 00 00       	call   3b20 <printf>
    exit();
    35fb:	e8 ca 03 00 00       	call   39ca <exit>
...
00003600 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    3607:	6a 00                	push   $0x0
    3609:	68 f3 4d 00 00       	push   $0x4df3
    360e:	e8 f7 03 00 00       	call   3a0a <open>
  if (fd < 0) {
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    361f:	6a 00                	push   $0x0
    3621:	e8 2c 04 00 00       	call   3a52 <sbrk>
    3626:	83 c4 0c             	add    $0xc,%esp
    3629:	83 e8 01             	sub    $0x1,%eax
    362c:	6a ff                	push   $0xffffffff
    362e:	50                   	push   %eax
    362f:	53                   	push   %ebx
    3630:	e8 ad 03 00 00       	call   39e2 <read>
  close(fd);
    3635:	89 1c 24             	mov    %ebx,(%esp)
    3638:	e8 b5 03 00 00       	call   39f2 <close>
  printf(1, "arg test passed\n");
    363d:	58                   	pop    %eax
    363e:	5a                   	pop    %edx
    363f:	68 05 4e 00 00       	push   $0x4e05
    3644:	6a 01                	push   $0x1
    3646:	e8 d5 04 00 00       	call   3b20 <printf>
}
    ...
    3653:	51                   	push   %ecx
    3654:	51                   	push   %ecx
    3655:	68 f8 4d 00 00       	push   $0x4df8
    365a:	6a 02                	push   $0x2
    365c:	e8 bf 04 00 00       	call   3b20 <printf>
    exit();
    3661:	e8 64 03 00 00       	call   39ca <exit>
...
00003670 <rand>:
  randstate = randstate * 1664525 + 1013904223;
    3670:	69 05 b4 5f 00 00 0d 	imul   $0x19660d,0x5fb4,%eax
    3677:	66 19 00 
    367a:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    367f:	a3 b4 5f 00 00       	mov    %eax,0x5fb4
}
    3684:	c3                   	ret
    ...
    37b9:	31 db                	xor    %ebx,%ebx
{
  ...
  for(i=0; i+1 < max; ){
    ...
    37c5:	56                   	push   %esi
    37c6:	6a 00                	push   $0x0
    37c8:	e8 15 02 00 00       	call   39e2 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
    ...
    381d:	e8 e8 01 00 00       	call   3a0a <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
    ...
    3831:	50                   	push   %eax
    3832:	e8 eb 01 00 00       	call   3a22 <fstat>
  close(fd);
    3837:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
    383a:	89 c6                	mov    %eax,%esi
  close(fd);
    383c:	e8 b1 01 00 00       	call   39f2 <close>
  return r;
...
thread_create(void(*start_routine)(void *, void *), void *arg1, void *arg2) 
{
  ...
  raw = malloc(PGSIZE * 2);
    ...
    38dc:	e8 5f 04 00 00       	call   3d40 <malloc>
  if (raw == 0) {
    38e1:	83 c4 10             	add    $0x10,%esp
    38e4:	85 c0                	test   %eax,%eax
    38e6:	74 37                	je     391f <thread_create+0x4f>
    38e8:	89 c3                	mov    %eax,%ebx
    return -1;
  }
  stack = (void *)(((uint)raw + sizeof(void *) + PGSIZE - 1) & ~(PGSIZE - 1));
    38ea:	8d 80 03 10 00 00    	lea    0x1003(%eax),%eax
    38f0:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  ((void **)stack)[-1] = raw;
    38f5:	89 58 fc             	mov    %ebx,-0x4(%eax)
  ...
  pid = clone(start_routine, arg1, arg2, stack);
    ...
    3902:	e8 63 01 00 00       	call   3a6a <clone>
  if (pid < 0) {
    3907:	83 c4 10             	add    $0x10,%esp
    390a:	85 c0                	test   %eax,%eax
    390c:	78 05                	js     3913 <thread_create+0x43>
    free(raw);
    return -1;
  }
  return pid;
    ...
    3916:	53                   	push   %ebx
    3917:	e8 94 03 00 00       	call   3cb0 <free>
    return -1;
    391c:	83 c4 10             	add    $0x10,%esp
    return -1;
    391f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
    3924:	eb e8                	jmp    390e <thread_create+0x3e>
    3926:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
    392d:	00 
...
thread_join(void) 
{
  ...
  pid = join(&stack);
    3934:	8d 45 f4             	lea    -0xc(%ebp),%eax
{
    3937:	83 ec 20             	sub    $0x20,%esp
  pid = join(&stack);
    393a:	50                   	push   %eax
    393b:	e8 32 01 00 00       	call   3a72 <join>
  if (pid < 0) {
    3940:	83 c4 10             	add    $0x10,%esp
    3943:	85 c0                	test   %eax,%eax
    3945:	78 21                	js     3968 <thread_join+0x38>
    3947:	89 c3                	mov    %eax,%ebx
    return -1;
  }
  raw = ((void **)stack)[-1];
    3949:	8b 45 f4             	mov    -0xc(%ebp),%eax
  free(raw);
    394c:	83 ec 0c             	sub    $0xc,%esp
    394f:	ff 70 fc             	push   -0x4(%eax)
    3952:	e8 59 03 00 00       	call   3cb0 <free>
  return pid;
    3957:	83 c4 10             	add    $0x10,%esp
}
    395a:	89 d8                	mov    %ebx,%eax
    395c:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    395f:	c9                   	leave
    3960:	c3                   	ret
    3961:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    return -1;
    3968:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
    396d:	eb eb                	jmp    395a <thread_join+0x2a>
    396f:	90                   	nop
...
lock_init(lock_t *lock)
{
  ...
  lock->ticket = 0;
    3976:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lock->turn = 0;
    397c:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
}
    3983:	5d                   	pop    %ebp
    3984:	c3                   	ret
    3985:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
    398c:	00 
...
lock_acquire(lock_t *lock)
{
    3990:	55                   	push   %ebp
  asm volatile (
    3991:	ba 01 00 00 00       	mov    $0x1,%edx
{
    3996:	89 e5                	mov    %esp,%ebp
    3998:	8b 4d 08             	mov    0x8(%ebp),%ecx
  asm volatile (
    399b:	f0 0f c1 11          	lock xadd %edx,(%ecx)
  int myturn = fetch_and_add(&lock->ticket, 1);
  while (myturn != lock->turn);
    399f:	90                   	nop
    39a0:	8b 41 04             	mov    0x4(%ecx),%eax
    39a3:	39 d0                	cmp    %edx,%eax
    39a5:	75 f9                	jne    39a0 <lock_acquire+0x10>
}
    39a7:	5d                   	pop    %ebp
    39a8:	c3                   	ret
...
lock_release(lock_t *lock)
{
    39b0:	55                   	push   %ebp
  asm volatile (
    39b1:	b8 01 00 00 00       	mov    $0x1,%eax
{
    39b6:	89 e5                	mov    %esp,%ebp
    39b8:	8b 55 08             	mov    0x8(%ebp),%edx
  asm volatile (
    39bb:	f0 0f c1 42 04       	lock xadd %eax,0x4(%edx)
...
000039ca <exit>:
SYSCALL(exit)
    39ca:	b8 02 00 00 00       	mov    $0x2,%eax
    39cf:	cd 40                	int    $0x40
    39d1:	c3                   	ret

000039d2 <wait>:
SYSCALL(wait)
    39d2:	b8 03 00 00 00       	mov    $0x3,%eax
    39d7:	cd 40                	int    $0x40
    39d9:	c3                   	ret

000039da <pipe>:
SYSCALL(pipe)
    39da:	b8 04 00 00 00       	mov    $0x4,%eax
    39df:	cd 40                	int    $0x40
    39e1:	c3                   	ret

000039e2 <read>:
SYSCALL(read)
    39e2:	b8 05 00 00 00       	mov    $0x5,%eax
    39e7:	cd 40                	int    $0x40
    39e9:	c3                   	ret

000039ea <write>:
SYSCALL(write)
    39ea:	b8 10 00 00 00       	mov    $0x10,%eax
    39ef:	cd 40                	int    $0x40
    39f1:	c3                   	ret

000039f2 <close>:
SYSCALL(close)
    39f2:	b8 15 00 00 00       	mov    $0x15,%eax
    39f7:	cd 40                	int    $0x40
    39f9:	c3                   	ret

000039fa <kill>:
SYSCALL(kill)
    39fa:	b8 06 00 00 00       	mov    $0x6,%eax
    39ff:	cd 40                	int    $0x40
    3a01:	c3                   	ret

00003a02 <exec>:
SYSCALL(exec)
    3a02:	b8 07 00 00 00       	mov    $0x7,%eax
    3a07:	cd 40                	int    $0x40
    3a09:	c3                   	ret

00003a0a <open>:
SYSCALL(open)
    3a0a:	b8 0f 00 00 00       	mov    $0xf,%eax
    3a0f:	cd 40                	int    $0x40
    3a11:	c3                   	ret

00003a12 <mknod>:
SYSCALL(mknod)
    3a12:	b8 11 00 00 00       	mov    $0x11,%eax
    3a17:	cd 40                	int    $0x40
    3a19:	c3                   	ret

00003a1a <unlink>:
SYSCALL(unlink)
    3a1a:	b8 12 00 00 00       	mov    $0x12,%eax
    3a1f:	cd 40                	int    $0x40
    3a21:	c3                   	ret

00003a22 <fstat>:
SYSCALL(fstat)
    3a22:	b8 08 00 00 00       	mov    $0x8,%eax
    3a27:	cd 40                	int    $0x40
    3a29:	c3                   	ret

00003a2a <link>:
SYSCALL(link)
    3a2a:	b8 13 00 00 00       	mov    $0x13,%eax
    3a2f:	cd 40                	int    $0x40
    3a31:	c3                   	ret

00003a32 <mkdir>:
SYSCALL(mkdir)
    3a32:	b8 14 00 00 00       	mov    $0x14,%eax
    3a37:	cd 40                	int    $0x40
    3a39:	c3                   	ret

00003a3a <chdir>:
SYSCALL(chdir)
    3a3a:	b8 09 00 00 00       	mov    $0x9,%eax
    3a3f:	cd 40                	int    $0x40
    3a41:	c3                   	ret

00003a42 <dup>:
SYSCALL(dup)
    3a42:	b8 0a 00 00 00       	mov    $0xa,%eax
    3a47:	cd 40                	int    $0x40
    3a49:	c3                   	ret

00003a4a <getpid>:
SYSCALL(getpid)
    3a4a:	b8 0b 00 00 00       	mov    $0xb,%eax
    3a4f:	cd 40                	int    $0x40
    3a51:	c3                   	ret

00003a52 <sbrk>:
SYSCALL(sbrk)
    3a52:	b8 0c 00 00 00       	mov    $0xc,%eax
    3a57:	cd 40                	int    $0x40
    3a59:	c3                   	ret

00003a5a <sleep>:
SYSCALL(sleep)
    3a5a:	b8 0d 00 00 00       	mov    $0xd,%eax
    3a5f:	cd 40                	int    $0x40
    3a61:	c3                   	ret

00003a62 <uptime>:
SYSCALL(uptime)
    3a62:	b8 0e 00 00 00       	mov    $0xe,%eax
    3a67:	cd 40                	int    $0x40
    3a69:	c3                   	ret

00003a6a <clone>:
SYSCALL(clone)
    3a6a:	b8 16 00 00 00       	mov    $0x16,%eax
    3a6f:	cd 40                	int    $0x40
    3a71:	c3                   	ret

00003a72 <join>:
SYSCALL(join)
    3a72:	b8 17 00 00 00       	mov    $0x17,%eax
    3a77:	cd 40                	int    $0x40
    3a79:	c3                   	ret
    ...
    3a88:	89 d1                	mov    %edx,%ecx
{
    ...
    3a8d:	89 45 c0             	mov    %eax,-0x40(%ebp)
  if(sgn && xx < 0){
    3a90:	85 d2                	test   %edx,%edx
    3a92:	0f 89 80 00 00 00    	jns    3b18 <printint+0x98>
    3a98:	f6 45 08 01          	testb  $0x1,0x8(%ebp)
    3a9c:	74 7a                	je     3b18 <printint+0x98>
    x = -xx;
    3a9e:	f7 d9                	neg    %ecx
    neg = 1;
    3aa0:	b8 01 00 00 00       	mov    $0x1,%eax
  } else {
    x = xx;
  }

  i = 0;
    3aa5:	89 45 c4             	mov    %eax,-0x3c(%ebp)
    3aa8:	31 f6                	xor    %esi,%esi
    3aaa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  do{
    buf[i++] = digits[x % base];
    3ab0:	89 c8                	mov    %ecx,%eax
    3ab2:	31 d2                	xor    %edx,%edx
    3ab4:	89 f7                	mov    %esi,%edi
    3ab6:	f7 f3                	div    %ebx
    3ab8:	8d 76 01             	lea    0x1(%esi),%esi
    3abb:	0f b6 92 20 56 00 00 	movzbl 0x5620(%edx),%edx
    3ac2:	88 54 35 d7          	mov    %dl,-0x29(%ebp,%esi,1)
  }while((x /= base) != 0);
    3ac6:	89 ca                	mov    %ecx,%edx
    3ac8:	89 c1                	mov    %eax,%ecx
    3aca:	39 da                	cmp    %ebx,%edx
    3acc:	73 e2                	jae    3ab0 <printint+0x30>
  if(neg)
    3ace:	8b 45 c4             	mov    -0x3c(%ebp),%eax
    3ad1:	85 c0                	test   %eax,%eax
    3ad3:	74 07                	je     3adc <printint+0x5c>
    buf[i++] = '-';
    3ad5:	c6 44 35 d8 2d       	movb   $0x2d,-0x28(%ebp,%esi,1)

  while(--i >= 0)
    3ada:	89 f7                	mov    %esi,%edi
    3adc:	8d 5d d8             	lea    -0x28(%ebp),%ebx
    3adf:	8b 75 c0             	mov    -0x40(%ebp),%esi
    3ae2:	01 df                	add    %ebx,%edi
    3ae4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    putc(fd, buf[i]);
    3ae8:	0f b6 07             	movzbl (%edi),%eax
  write(fd, &c, 1);
    3aeb:	83 ec 04             	sub    $0x4,%esp
    3aee:	88 45 d7             	mov    %al,-0x29(%ebp)
    3af1:	8d 45 d7             	lea    -0x29(%ebp),%eax
    3af4:	6a 01                	push   $0x1
    3af6:	50                   	push   %eax
    3af7:	56                   	push   %esi
    3af8:	e8 ed fe ff ff       	call   39ea <write>
  while(--i >= 0)
    3afd:	89 f8                	mov    %edi,%eax
    3aff:	83 c4 10             	add    $0x10,%esp
    3b02:	83 ef 01             	sub    $0x1,%edi
    3b05:	39 c3                	cmp    %eax,%ebx
    3b07:	75 df                	jne    3ae8 <printint+0x68>
}
    3b09:	8d 65 f4             	lea    -0xc(%ebp),%esp
    3b0c:	5b                   	pop    %ebx
    3b0d:	5e                   	pop    %esi
    3b0e:	5f                   	pop    %edi
    3b0f:	5d                   	pop    %ebp
  ...
  neg = 0;
    3b18:	31 c0                	xor    %eax,%eax
    3b1a:	eb 89                	jmp    3aa5 <printint+0x25>
...
printf(int fd, const char *fmt, ...)
{
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    3b29:	8b 75 0c             	mov    0xc(%ebp),%esi
{
    3b2c:	8b 7d 08             	mov    0x8(%ebp),%edi
  for(i = 0; fmt[i]; i++){
    3b2f:	0f b6 1e             	movzbl (%esi),%ebx
    3b32:	83 c6 01             	add    $0x1,%esi
    3b35:	84 db                	test   %bl,%bl
    3b37:	74 67                	je     3ba0 <printf+0x80>
    3b39:	8d 4d 10             	lea    0x10(%ebp),%ecx
    3b3c:	31 d2                	xor    %edx,%edx
    3b3e:	89 4d d0             	mov    %ecx,-0x30(%ebp)
    3b41:	eb 34                	jmp    3b77 <printf+0x57>
    3b43:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
    3b48:	89 55 d4             	mov    %edx,-0x2c(%ebp)
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
        state = '%';
    3b4b:	ba 25 00 00 00       	mov    $0x25,%edx
      if(c == '%'){
    3b50:	83 f8 25             	cmp    $0x25,%eax
    3b53:	74 18                	je     3b6d <printf+0x4d>
  write(fd, &c, 1);
    3b55:	83 ec 04             	sub    $0x4,%esp
    3b58:	8d 45 e7             	lea    -0x19(%ebp),%eax
    3b5b:	88 5d e7             	mov    %bl,-0x19(%ebp)
    3b5e:	6a 01                	push   $0x1
    3b60:	50                   	push   %eax
    3b61:	57                   	push   %edi
    3b62:	e8 83 fe ff ff       	call   39ea <write>
    3b67:	8b 55 d4             	mov    -0x2c(%ebp),%edx
      } else {
        putc(fd, c);
    3b6a:	83 c4 10             	add    $0x10,%esp
  for(i = 0; fmt[i]; i++){
    3b6d:	0f b6 1e             	movzbl (%esi),%ebx
    3b70:	83 c6 01             	add    $0x1,%esi
    3b73:	84 db                	test   %bl,%bl
    3b75:	74 29                	je     3ba0 <printf+0x80>
    c = fmt[i] & 0xff;
    3b77:	0f b6 c3             	movzbl %bl,%eax
    if(state == 0){
    3b7a:	85 d2                	test   %edx,%edx
    3b7c:	74 ca                	je     3b48 <printf+0x28>
      }
    } else if(state == '%'){
    3b7e:	83 fa 25             	cmp    $0x25,%edx
    3b81:	75 ea                	jne    3b6d <printf+0x4d>
      if(c == 'd'){
    3b83:	83 f8 25             	cmp    $0x25,%eax
    3b86:	0f 84 04 01 00 00    	je     3c90 <printf+0x170>
    3b8c:	83 e8 63             	sub    $0x63,%eax
    3b8f:	83 f8 15             	cmp    $0x15,%eax
    3b92:	77 1c                	ja     3bb0 <printf+0x90>
    3b94:	ff 24 85 c8 55 00 00 	jmp    *0x55c8(,%eax,4)
    3b9b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
        putc(fd, c);
      }
      state = 0;
    }
    ...
    3ba0:	8d 65 f4             	lea    -0xc(%ebp),%esp
    3ba3:	5b                   	pop    %ebx
    3ba4:	5e                   	pop    %esi
    3ba5:	5f                   	pop    %edi
    3ba6:	5d                   	pop    %ebp
    3ba7:	c3                   	ret
    3ba8:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
    3baf:	00 
  write(fd, &c, 1);
    3bb0:	83 ec 04             	sub    $0x4,%esp
    3bb3:	8d 55 e7             	lea    -0x19(%ebp),%edx
    3bb6:	c6 45 e7 25          	movb   $0x25,-0x19(%ebp)
    3bba:	6a 01                	push   $0x1
    3bbc:	52                   	push   %edx
    3bbd:	89 55 d4             	mov    %edx,-0x2c(%ebp)
    3bc0:	57                   	push   %edi
    3bc1:	e8 24 fe ff ff       	call   39ea <write>
    3bc6:	83 c4 0c             	add    $0xc,%esp
    3bc9:	88 5d e7             	mov    %bl,-0x19(%ebp)
    3bcc:	6a 01                	push   $0x1
    3bce:	8b 55 d4             	mov    -0x2c(%ebp),%edx
    3bd1:	52                   	push   %edx
    3bd2:	57                   	push   %edi
    3bd3:	e8 12 fe ff ff       	call   39ea <write>
        putc(fd, c);
    3bd8:	83 c4 10             	add    $0x10,%esp
      state = 0;
    3bdb:	31 d2                	xor    %edx,%edx
    3bdd:	eb 8e                	jmp    3b6d <printf+0x4d>
    3bdf:	90                   	nop
        printint(fd, *ap, 16, 0);
    3be0:	8b 5d d0             	mov    -0x30(%ebp),%ebx
    3be3:	83 ec 0c             	sub    $0xc,%esp
    3be6:	b9 10 00 00 00       	mov    $0x10,%ecx
    3beb:	8b 13                	mov    (%ebx),%edx
    3bed:	6a 00                	push   $0x0
    3bef:	89 f8                	mov    %edi,%eax
        ap++;
    3bf1:	83 c3 04             	add    $0x4,%ebx
        printint(fd, *ap, 16, 0);
    3bf4:	e8 87 fe ff ff       	call   3a80 <printint>
        ap++;
    3bf9:	89 5d d0             	mov    %ebx,-0x30(%ebp)
    3bfc:	83 c4 10             	add    $0x10,%esp
      state = 0;
    3bff:	31 d2                	xor    %edx,%edx
    3c01:	e9 67 ff ff ff       	jmp    3b6d <printf+0x4d>
        s = (char*)*ap;
    3c06:	8b 45 d0             	mov    -0x30(%ebp),%eax
    3c09:	8b 18                	mov    (%eax),%ebx
        ap++;
    3c0b:	83 c0 04             	add    $0x4,%eax
    3c0e:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
    3c11:	85 db                	test   %ebx,%ebx
    3c13:	0f 84 87 00 00 00    	je     3ca0 <printf+0x180>
        while(*s != 0){
    3c19:	0f b6 03             	movzbl (%ebx),%eax
      state = 0;
    3c1c:	31 d2                	xor    %edx,%edx
        while(*s != 0){
    3c1e:	84 c0                	test   %al,%al
    3c20:	0f 84 47 ff ff ff    	je     3b6d <printf+0x4d>
    3c26:	8d 55 e7             	lea    -0x19(%ebp),%edx
    3c29:	89 75 d4             	mov    %esi,-0x2c(%ebp)
    3c2c:	89 de                	mov    %ebx,%esi
    3c2e:	89 d3                	mov    %edx,%ebx
  write(fd, &c, 1);
    3c30:	83 ec 04             	sub    $0x4,%esp
    3c33:	88 45 e7             	mov    %al,-0x19(%ebp)
          s++;
    3c36:	83 c6 01             	add    $0x1,%esi
  write(fd, &c, 1);
    3c39:	6a 01                	push   $0x1
    3c3b:	53                   	push   %ebx
    3c3c:	57                   	push   %edi
    3c3d:	e8 a8 fd ff ff       	call   39ea <write>
        while(*s != 0){
    3c42:	0f b6 06             	movzbl (%esi),%eax
    3c45:	83 c4 10             	add    $0x10,%esp
    3c48:	84 c0                	test   %al,%al
    3c4a:	75 e4                	jne    3c30 <printf+0x110>
      state = 0;
    3c4c:	8b 75 d4             	mov    -0x2c(%ebp),%esi
    3c4f:	31 d2                	xor    %edx,%edx
    3c51:	e9 17 ff ff ff       	jmp    3b6d <printf+0x4d>
        printint(fd, *ap, 10, 1);
    3c56:	8b 5d d0             	mov    -0x30(%ebp),%ebx
    3c59:	83 ec 0c             	sub    $0xc,%esp
    3c5c:	b9 0a 00 00 00       	mov    $0xa,%ecx
    3c61:	8b 13                	mov    (%ebx),%edx
    3c63:	6a 01                	push   $0x1
    3c65:	eb 88                	jmp    3bef <printf+0xcf>
        putc(fd, *ap);
    3c67:	8b 5d d0             	mov    -0x30(%ebp),%ebx
  write(fd, &c, 1);
    3c6a:	83 ec 04             	sub    $0x4,%esp
    3c6d:	8d 55 e7             	lea    -0x19(%ebp),%edx
        putc(fd, *ap);
    3c70:	8b 03                	mov    (%ebx),%eax
        ap++;
    3c72:	83 c3 04             	add    $0x4,%ebx
        putc(fd, *ap);
    3c75:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
    3c78:	6a 01                	push   $0x1
    3c7a:	52                   	push   %edx
    3c7b:	57                   	push   %edi
    3c7c:	e8 69 fd ff ff       	call   39ea <write>
        ap++;
    3c81:	89 5d d0             	mov    %ebx,-0x30(%ebp)
    3c84:	83 c4 10             	add    $0x10,%esp
      state = 0;
    3c87:	31 d2                	xor    %edx,%edx
    3c89:	e9 df fe ff ff       	jmp    3b6d <printf+0x4d>
    3c8e:	66 90                	xchg   %ax,%ax
  write(fd, &c, 1);
    3c90:	83 ec 04             	sub    $0x4,%esp
    3c93:	88 5d e7             	mov    %bl,-0x19(%ebp)
    3c96:	8d 55 e7             	lea    -0x19(%ebp),%edx
    3c99:	6a 01                	push   $0x1
    3c9b:	e9 31 ff ff ff       	jmp    3bd1 <printf+0xb1>
    3ca0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
    3ca5:	bb 49 4e 00 00       	mov    $0x4e49,%ebx
    3caa:	e9 77 ff ff ff       	jmp    3c26 <printf+0x106>
    3caf:	90                   	nop
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3cb1:	a1 80 a7 00 00       	mov    0xa780,%eax
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    3cc8:	8b 10                	mov    (%eax),%edx
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3cca:	39 c8                	cmp    %ecx,%eax
    3ccc:	73 32                	jae    3d00 <free+0x50>
    3cce:	39 d1                	cmp    %edx,%ecx
    3cd0:	72 04                	jb     3cd6 <free+0x26>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    3cd2:	39 d0                	cmp    %edx,%eax
    3cd4:	72 32                	jb     3d08 <free+0x58>
      break;
  if(bp + bp->s.size == p->s.ptr){
    3cd6:	8b 73 fc             	mov    -0x4(%ebx),%esi
    3cd9:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
    3cdc:	39 fa                	cmp    %edi,%edx
    3cde:	74 30                	je     3d10 <free+0x60>
    ...
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    3ce3:	8b 50 04             	mov    0x4(%eax),%edx
    3ce6:	8d 34 d0             	lea    (%eax,%edx,8),%esi
    3ce9:	39 f1                	cmp    %esi,%ecx
    3ceb:	74 3a                	je     3d27 <free+0x77>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
    3ced:	89 08                	mov    %ecx,(%eax)
  } else
    p->s.ptr = bp;
  freep = p;
}
    3cef:	5b                   	pop    %ebx
  freep = p;
    3cf0:	a3 80 a7 00 00       	mov    %eax,0xa780
}
    3cf5:	5e                   	pop    %esi
    3cf6:	5f                   	pop    %edi
    3cf7:	5d                   	pop    %ebp
    ...
    3d02:	72 04                	jb     3d08 <free+0x58>
    3d04:	39 d1                	cmp    %edx,%ecx
    3d06:	72 ce                	jb     3cd6 <free+0x26>
{
    3d08:	89 d0                	mov    %edx,%eax
    3d0a:	eb bc                	jmp    3cc8 <free+0x18>
  ...
  if(p + p->s.size == bp){
    ...
    3d25:	75 c6                	jne    3ced <free+0x3d>
    p->s.size += bp->s.size;
    3d27:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
    3d2a:	a3 80 a7 00 00       	mov    %eax,0xa780
    p->s.size += bp->s.size;
    3d2f:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    3d32:	8b 4b f8             	mov    -0x8(%ebx),%ecx
    3d35:	89 08                	mov    %ecx,(%eax)
}
    3d37:	5b                   	pop    %ebx
    3d38:	5e                   	pop    %esi
    3d39:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    3d4c:	8b 15 80 a7 00 00    	mov    0xa780,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    3d8b:	3b 05 80 a7 00 00    	cmp    0xa780,%eax
    3d91:	75 ed                	jne    3d80 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
    3d93:	83 ec 0c             	sub    $0xc,%esp
    3d96:	56                   	push   %esi
    3d97:	e8 b6 fc ff ff       	call   3a52 <sbrk>
  if(p == (char*)-1)
  ...
  free((void*)(hp + 1));
    ...
    3dad:	50                   	push   %eax
    3dae:	e8 fd fe ff ff       	call   3cb0 <free>
  return freep;
    3db3:	8b 15 80 a7 00 00    	mov    0xa780,%edx
    ...
    3df7:	a7 00 00 
    base.s.size = 0;
    3dfa:	b8 84 a7 00 00       	mov    $0xa784,%eax
    base.s.ptr = freep = prevp = &base;
    3dff:	c7 05 84 a7 00 00 84 	movl   $0xa784,0xa784
    3e06:	a7 00 00 
    base.s.size = 0;
    3e09:	c7 05 88 a7 00 00 00 	movl   $0x0,0xa788
    3e10:	00 00 00 
    if(p->s.size >= nunits){
