...
main(void)
{
  ...
  if(fork() > 0)
  11:	e8 4c 03 00 00       	call   362 <fork>
  16:	85 c0                	test   %eax,%eax
  18:	7e 0d                	jle    27 <main+0x27>
    sleep(5);  // Let child exit before parent.
  1a:	83 ec 0c             	sub    $0xc,%esp
  1d:	6a 05                	push   $0x5
  1f:	e8 d6 03 00 00       	call   3fa <sleep>
  24:	83 c4 10             	add    $0x10,%esp
  exit();
  27:	e8 3e 03 00 00       	call   36a <exit>
  2c:	66 90                	xchg   %ax,%ax
  2e:	66 90                	xchg   %ax,%ax
 ...
 159:	31 db                	xor    %ebx,%ebx
{
 ...
 165:	56                   	push   %esi
 166:	6a 00                	push   $0x0
 168:	e8 15 02 00 00       	call   382 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1bd:	e8 e8 01 00 00       	call   3aa <open>
  if(fd < 0)
 ...
 1d1:	50                   	push   %eax
 1d2:	e8 eb 01 00 00       	call   3c2 <fstat>
  close(fd);
 1d7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 1da:	89 c6                	mov    %eax,%esi
  close(fd);
 1dc:	e8 b1 01 00 00       	call   392 <close>
  return r;
...
thread_create(void(*start_routine)(void *, void *), void *arg1, void *arg2) 
{
 ...
 27c:	e8 5f 04 00 00       	call   6e0 <malloc>
  if (raw == 0) {
 281:	83 c4 10             	add    $0x10,%esp
 284:	85 c0                	test   %eax,%eax
 286:	74 37                	je     2bf <thread_create+0x4f>
 288:	89 c3                	mov    %eax,%ebx
    return -1;
  }
  stack = (void *)(((uint)raw + sizeof(void *) + PGSIZE - 1) & ~(PGSIZE - 1));
 28a:	8d 80 03 10 00 00    	lea    0x1003(%eax),%eax
 290:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  ((void **)stack)[-1] = raw;
 295:	89 58 fc             	mov    %ebx,-0x4(%eax)
 ...
 2a2:	e8 63 01 00 00       	call   40a <clone>
  if (pid < 0) {
 2a7:	83 c4 10             	add    $0x10,%esp
 2aa:	85 c0                	test   %eax,%eax
 2ac:	78 05                	js     2b3 <thread_create+0x43>
    free(raw);
    return -1;
  }
  return pid;
 ...
 2b6:	53                   	push   %ebx
 2b7:	e8 94 03 00 00       	call   650 <free>
    return -1;
 2bc:	83 c4 10             	add    $0x10,%esp
    return -1;
 2bf:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 2c4:	eb e8                	jmp    2ae <thread_create+0x3e>
 ...
 2d4:	8d 45 f4             	lea    -0xc(%ebp),%eax
{
 2d7:	83 ec 20             	sub    $0x20,%esp
  pid = join(&stack);
 2da:	50                   	push   %eax
 2db:	e8 32 01 00 00       	call   412 <join>
  if (pid < 0) {
 2e0:	83 c4 10             	add    $0x10,%esp
 2e3:	85 c0                	test   %eax,%eax
 2e5:	78 21                	js     308 <thread_join+0x38>
 ...
 2ef:	ff 70 fc             	push   -0x4(%eax)
 2f2:	e8 59 03 00 00       	call   650 <free>
  return pid;
 ...
 301:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    return -1;
 308:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
 30d:	eb eb                	jmp    2fa <thread_join+0x2a>
 30f:	90                   	nop
 ...
 331:	ba 01 00 00 00       	mov    $0x1,%edx
{
 ...
 338:	8b 4d 08             	mov    0x8(%ebp),%ecx
  asm volatile (
 33b:	f0 0f c1 11          	lock xadd %edx,(%ecx)
  int myturn = fetch_and_add(&lock->ticket, 1);
  while (myturn != lock->turn);
 33f:	90                   	nop
 340:	8b 41 04             	mov    0x4(%ecx),%eax
 343:	39 d0                	cmp    %edx,%eax
 345:	75 f9                	jne    340 <lock_acquire+0x10>
}
 347:	5d                   	pop    %ebp
 348:	c3                   	ret
 ...
 428:	89 d1                	mov    %edx,%ecx
{
 ...
 45b:	0f b6 92 28 08 00 00 	movzbl 0x828(%edx),%edx
 ...
 496:	50                   	push   %eax
 497:	56                   	push   %esi
 498:	e8 ed fe ff ff       	call   38a <write>
  while(--i >= 0)
 ...
 4c9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 500:	50                   	push   %eax
 501:	57                   	push   %edi
 502:	e8 83 fe ff ff       	call   38a <write>
 ...
 534:	ff 24 85 d0 07 00 00 	jmp    *0x7d0(,%eax,4)
 ...
 571:	52                   	push   %edx
 572:	57                   	push   %edi
 573:	e8 12 fe ff ff       	call   38a <write>
        putc(fd, c);
 ...
 5db:	53                   	push   %ebx
 5dc:	57                   	push   %edi
 5dd:	e8 a8 fd ff ff       	call   38a <write>
        while(*s != 0){
 ...
 640:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 645:	bb c8 07 00 00       	mov    $0x7c8,%ebx
...
free(void *ap)
{
 ...
 651:	a1 74 0b 00 00       	mov    0xb74,%eax
{
 ...
 68f:	5b                   	pop    %ebx
  freep = p;
 690:	a3 74 0b 00 00       	mov    %eax,0xb74
}
 695:	5e                   	pop    %esi
 696:	5f                   	pop    %edi
 697:	5d                   	pop    %ebp
 ...
 6a6:	72 ce                	jb     676 <free+0x26>
{
 ...
 6c7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ca:	a3 74 0b 00 00       	mov    %eax,0xb74
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ec:	8b 15 74 0b 00 00    	mov    0xb74,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 72b:	3b 05 74 0b 00 00    	cmp    0xb74,%eax
 731:	75 ed                	jne    720 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
 733:	83 ec 0c             	sub    $0xc,%esp
 736:	56                   	push   %esi
 737:	e8 b6 fc ff ff       	call   3f2 <sbrk>
  if(p == (char*)-1)
 ...
 74e:	e8 fd fe ff ff       	call   650 <free>
  return freep;
 753:	8b 15 74 0b 00 00    	mov    0xb74,%edx
 ...
 797:	0b 00 00 
    base.s.size = 0;
 79a:	b8 78 0b 00 00       	mov    $0xb78,%eax
    base.s.ptr = freep = prevp = &base;
 79f:	c7 05 78 0b 00 00 78 	movl   $0xb78,0xb78
 7a6:	0b 00 00 
    base.s.size = 0;
 7a9:	c7 05 7c 0b 00 00 00 	movl   $0x0,0xb7c
 7b0:	00 00 00 
    if(p->s.size >= nunits){
